...
public class ModifyInventoryControllerApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteFutureInventoryCall(Integer xVolTenant, DeleteFutureItemRequest deleteFutureItemRequest, Integer xVolSite, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = deleteFutureItemRequest;

        // create path and map variables
        String localVarPath = "/v5/inventory/deleteFutureInventory/";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteFutureInventoryValidateBeforeCall(Integer xVolTenant, DeleteFutureItemRequest deleteFutureItemRequest, Integer xVolSite, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteFutureInventoryCall(xVolTenant, deleteFutureItemRequest, xVolSite, progressListener, progressRequestListener);
        return call;
    ...
    public DeleteFutureItemResponse deleteFutureInventory(Integer xVolTenant, DeleteFutureItemRequest deleteFutureItemRequest, Integer xVolSite) throws ApiException {
        ApiResponse<DeleteFutureItemResponse> resp = deleteFutureInventoryWithHttpInfo(xVolTenant, deleteFutureItemRequest, xVolSite);
        return resp.getData();
    }
    ...
    public ApiResponse<DeleteFutureItemResponse> deleteFutureInventoryWithHttpInfo(Integer xVolTenant, DeleteFutureItemRequest deleteFutureItemRequest, Integer xVolSite) throws ApiException {
        com.squareup.okhttp.Call call = deleteFutureInventoryValidateBeforeCall(xVolTenant, deleteFutureItemRequest, xVolSite, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteFutureInventoryAsync(Integer xVolTenant, DeleteFutureItemRequest deleteFutureItemRequest, Integer xVolSite, final ApiCallback<DeleteFutureItemResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteFutureInventoryValidateBeforeCall(xVolTenant, deleteFutureItemRequest, xVolSite, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteFutureItemResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteItemsCall(Integer xVolTenant, DeleteItemsRequest deleteItemsRequest, Integer xVolSite, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = deleteItemsRequest;

        // create path and map variables
        String localVarPath = "/v5/inventory/deleteItems/";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteItemsValidateBeforeCall(Integer xVolTenant, DeleteItemsRequest deleteItemsRequest, Integer xVolSite, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteItemsCall(xVolTenant, deleteItemsRequest, xVolSite, progressListener, progressRequestListener);
        return call;
    ...
    public DeleteItemResponse deleteItems(Integer xVolTenant, DeleteItemsRequest deleteItemsRequest, Integer xVolSite) throws ApiException {
        ApiResponse<DeleteItemResponse> resp = deleteItemsWithHttpInfo(xVolTenant, deleteItemsRequest, xVolSite);
        return resp.getData();
    }
    ...
    public ApiResponse<DeleteItemResponse> deleteItemsWithHttpInfo(Integer xVolTenant, DeleteItemsRequest deleteItemsRequest, Integer xVolSite) throws ApiException {
        com.squareup.okhttp.Call call = deleteItemsValidateBeforeCall(xVolTenant, deleteItemsRequest, xVolSite, null, null);
        Type localVarReturnType = new TypeToken<DeleteItemResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteItemsAsync(Integer xVolTenant, DeleteItemsRequest deleteItemsRequest, Integer xVolSite, final ApiCallback<DeleteItemResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteItemsValidateBeforeCall(xVolTenant, deleteItemsRequest, xVolSite, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteItemResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
