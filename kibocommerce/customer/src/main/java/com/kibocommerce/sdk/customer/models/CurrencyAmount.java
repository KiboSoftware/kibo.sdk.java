 ...
 */
@ApiModel(description = "The currency code and amount of an order listed in the order history of a customer account. Currently, only USD is supported.")
...
public class CurrencyAmount implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "Currency code for the amount of the order. Currently, only \"USD\" is supported.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total amount of the order. Currently, only US dollar amounts are supported.")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CurrencyAmount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CurrencyAmount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyAmount is not found in the empty JSON string", CurrencyAmount.openapiRequiredFields.toString()));
        }
      }
      ...
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyAmount` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CurrencyAmount>() {
           @Override
