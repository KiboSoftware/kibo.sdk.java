 ...
 */
@ApiModel(description = "Refund associated with an order. A refund is a single exchange of money from merchant to customer  that either encapsulates a refund to a credit card or an issuance of a store credit.  A refund does not reduce the 'amount collected' on an order and it is possible for a refund to exceed the total order amount.")
...
public class Refund implements Serializable {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique identifier of the order with which this refund is associated.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Merchant-entered reason for this refund.")
  ...
  **/
  ...
  public Refund refundMethod(String refundMethod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Refund Method.")
  ...
  public Refund auditInfo(AdminUserAuditInfo auditInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, refund.id) &&
        ...
        Objects.equals(this.refundMethod, refund.refundMethod) &&
        Objects.equals(this.auditInfo, refund.auditInfo);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, orderId, reason, reasonCode, payment, amount, refundMethod, auditInfo);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Refund` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
