 ...
 */
@ApiModel(description = "A schema element describing a name/value pair that can be stored on a document's properties field, where the name is directly defined by the propertyName and the value is constrained by the propertyType.")
...
public class Property implements Serializable {
  ...
  public Property name(String name) {
   ...
   /**
   * The name portion of the name/value pair stored on a document&#39;s properties field. The property name value must be unique within the properties defined on the documentType.  This value cannot be updated after property creation.
   * @return name
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name portion of the name/value pair stored on a document's properties field. The property name value must be unique within the properties defined on the documentType.  This value cannot be updated after property creation.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "True if the property must be present on the document. This value is false by default.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "True if the property value is an array, where each array value must conform to the propertyType. When false, the property value must directly conform to the propertyType. This value is false by default.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, property.name) &&
        Objects.equals(this.isRequired, property.isRequired) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, isRequired, isMultiValued, propertyType);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("propertyType") != null && !jsonObj.get("propertyType").isJsonNull()) {
        PropertyType.validateJsonObject(jsonObj.getAsJsonObject("propertyType"));
      }
  }
