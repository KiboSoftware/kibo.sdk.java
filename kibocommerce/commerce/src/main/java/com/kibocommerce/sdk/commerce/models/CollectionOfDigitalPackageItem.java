...
import com.kibocommerce.sdk.commerce.models.DigitalPackageItem;
...
public class CollectionOfDigitalPackageItem implements Serializable {
  ...
  private List<DigitalPackageItem> items = null;
  ...
  public CollectionOfDigitalPackageItem() {
  }

  public CollectionOfDigitalPackageItem id(String id) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem code(String code) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem status(String status) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem items(List<DigitalPackageItem> items) {
    
    this.items = items;
    return this;
  }

  public CollectionOfDigitalPackageItem addItemsItem(DigitalPackageItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem fulfillmentDate(OffsetDateTime fulfillmentDate) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem fulfillmentLocationCode(String fulfillmentLocationCode) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem auditInfo(AdminUserAuditInfo auditInfo) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem availableActions(List<String> availableActions) {
    
    this.availableActions = availableActions;
    return this;
  }

  public CollectionOfDigitalPackageItem addAvailableActionsItem(String availableActionsItem) {
  ...
  **/
  ...
  public CollectionOfDigitalPackageItem changeMessages(List<CommerceRuntimeChangeMessage> changeMessages) {
    
    this.changeMessages = changeMessages;
    return this;
  }

  public CollectionOfDigitalPackageItem addChangeMessagesItem(CommerceRuntimeChangeMessage changeMessagesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CollectionOfDigitalPackageItem collectionOfDigitalPackageItem = (CollectionOfDigitalPackageItem) o;
    return Objects.equals(this.id, collectionOfDigitalPackageItem.id) &&
        Objects.equals(this.code, collectionOfDigitalPackageItem.code) &&
        Objects.equals(this.status, collectionOfDigitalPackageItem.status) &&
        Objects.equals(this.items, collectionOfDigitalPackageItem.items) &&
        Objects.equals(this.fulfillmentDate, collectionOfDigitalPackageItem.fulfillmentDate) &&
        Objects.equals(this.fulfillmentLocationCode, collectionOfDigitalPackageItem.fulfillmentLocationCode) &&
        Objects.equals(this.auditInfo, collectionOfDigitalPackageItem.auditInfo) &&
        Objects.equals(this.availableActions, collectionOfDigitalPackageItem.availableActions) &&
        Objects.equals(this.changeMessages, collectionOfDigitalPackageItem.changeMessages);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionOfDigitalPackageItem {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollectionOfDigitalPackageItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollectionOfDigitalPackageItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionOfDigitalPackageItem is not found in the empty JSON string", CollectionOfDigitalPackageItem.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!CollectionOfDigitalPackageItem.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CollectionOfDigitalPackageItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            DigitalPackageItem.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionOfDigitalPackageItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionOfDigitalPackageItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectionOfDigitalPackageItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectionOfDigitalPackageItem.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectionOfDigitalPackageItem>() {
           @Override
           public void write(JsonWriter out, CollectionOfDigitalPackageItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CollectionOfDigitalPackageItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CollectionOfDigitalPackageItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CollectionOfDigitalPackageItem
  * @throws IOException if the JSON string is invalid with respect to CollectionOfDigitalPackageItem
  */
  public static CollectionOfDigitalPackageItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectionOfDigitalPackageItem.class);
  }

 /**
  * Convert an instance of CollectionOfDigitalPackageItem to an JSON string
  *
  * @return JSON string
  */
