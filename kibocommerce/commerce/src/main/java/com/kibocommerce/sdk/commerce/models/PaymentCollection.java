 ...
 */
@ApiModel(description = "A collection of payment transactions.")
...
public class PaymentCollection implements Serializable {
  ...
  public PaymentCollection totalCount(Integer totalCount) {
  ...
  **/
  ...
  public PaymentCollection items(List<Payment> items) {
    
    this.items = items;
    return this;
  }

  public PaymentCollection addItemsItem(Payment itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCount, paymentCollection.totalCount) &&
        Objects.equals(this.items, paymentCollection.items);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      //  if (!PaymentCollection.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentCollection` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Payment.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  }
