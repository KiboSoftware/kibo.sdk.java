...
public class DigitalPackage implements Serializable {
  ...
  public DigitalPackage id(String id) {
  ...
  **/
  ...
  public DigitalPackage code(String code) {
  ...
  **/
  ...
  public DigitalPackage status(String status) {
  ...
  **/
  ...
  public DigitalPackage items(List<DigitalPackageItem> items) {
    
    this.items = items;
    return this;
  }

  public DigitalPackage addItemsItem(DigitalPackageItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public DigitalPackage fulfillmentDate(OffsetDateTime fulfillmentDate) {
  ...
  **/
  ...
  public DigitalPackage fulfillmentLocationCode(String fulfillmentLocationCode) {
  ...
  **/
  ...
  public DigitalPackage auditInfo(AdminUserAuditInfo auditInfo) {
  ...
  **/
  ...
  public DigitalPackage availableActions(List<String> availableActions) {
    
    this.availableActions = availableActions;
    return this;
  }

  public DigitalPackage addAvailableActionsItem(String availableActionsItem) {
  ...
  **/
  ...
  public DigitalPackage changeMessages(List<CommerceRuntimeChangeMessage> changeMessages) {
    
    this.changeMessages = changeMessages;
    return this;
  }

  public DigitalPackage addChangeMessagesItem(CommerceRuntimeChangeMessage changeMessagesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DigitalPackage digitalPackage = (DigitalPackage) o;
    return Objects.equals(this.id, digitalPackage.id) &&
        Objects.equals(this.code, digitalPackage.code) &&
        Objects.equals(this.status, digitalPackage.status) &&
        Objects.equals(this.items, digitalPackage.items) &&
        Objects.equals(this.fulfillmentDate, digitalPackage.fulfillmentDate) &&
        Objects.equals(this.fulfillmentLocationCode, digitalPackage.fulfillmentLocationCode) &&
        Objects.equals(this.auditInfo, digitalPackage.auditInfo) &&
        Objects.equals(this.availableActions, digitalPackage.availableActions) &&
        Objects.equals(this.changeMessages, digitalPackage.changeMessages);
  }
  ...
  public String toString() {
    ...
    sb.append("class DigitalPackage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DigitalPackage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DigitalPackage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DigitalPackage is not found in the empty JSON string", DigitalPackage.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!DigitalPackage.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DigitalPackage` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DigitalPackage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DigitalPackage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DigitalPackage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DigitalPackage.class));

       return (TypeAdapter<T>) new TypeAdapter<DigitalPackage>() {
           @Override
           public void write(JsonWriter out, DigitalPackage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DigitalPackage read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DigitalPackage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DigitalPackage
  * @throws IOException if the JSON string is invalid with respect to DigitalPackage
  */
  public static DigitalPackage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DigitalPackage.class);
  }

 /**
  * Convert an instance of DigitalPackage to an JSON string
  *
  * @return JSON string
  */
