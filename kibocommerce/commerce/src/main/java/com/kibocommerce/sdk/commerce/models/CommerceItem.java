 ...
 */
@ApiModel(description = "Base class for cart and order items")
...
public class CommerceItem implements Serializable {
  ...
  public CommerceItem localeCode(String localeCode) {
  ...
  **/
  ...
  public CommerceItem purchaseLocation(String purchaseLocation) {
  ...
  **/
  ...
  public CommerceItem lineId(Integer lineId) {
  ...
  **/
  ...
  public CommerceItem product(CommerceRuntimeProduct product) {
  ...
  **/
  ...
  public CommerceItem isRecurring(Boolean isRecurring) {
  ...
  **/
  ...
  public CommerceItem isTaxable(Boolean isTaxable) {
  ...
  **/
  ...
  public CommerceItem subtotal(Double subtotal) {
  ...
  **/
  ...
  public CommerceItem extendedTotal(Double extendedTotal) {
  ...
  **/
  ...
  public CommerceItem taxableTotal(Double taxableTotal) {
  ...
  **/
  ...
  public CommerceItem discountTotal(Double discountTotal) {
  ...
  **/
  ...
  public CommerceItem discountedTotal(Double discountedTotal) {
  ...
  **/
  ...
  public CommerceItem itemTaxTotal(Double itemTaxTotal) {
  ...
  **/
  ...
  public CommerceItem shippingTaxTotal(Double shippingTaxTotal) {
  ...
  **/
  ...
  public CommerceItem shippingTotal(Double shippingTotal) {
  ...
  **/
  ...
  public CommerceItem handlingAmount(Double handlingAmount) {
  ...
  **/
  ...
  public CommerceItem feeTotal(Double feeTotal) {
  ...
  **/
  ...
  public CommerceItem total(Double total) {
  ...
  **/
  ...
  public CommerceItem unitPrice(CommerceUnitPrice unitPrice) {
  ...
  **/
  ...
  public CommerceItem productDiscount(CommerceRuntimeAppliedLineItemProductDiscount productDiscount) {
  ...
  **/
  ...
  public CommerceItem productDiscounts(List<CommerceRuntimeAppliedLineItemProductDiscount> productDiscounts) {
    
    this.productDiscounts = productDiscounts;
    return this;
  }

  public CommerceItem addProductDiscountsItem(CommerceRuntimeAppliedLineItemProductDiscount productDiscountsItem) {
  ...
  **/
  ...
  public CommerceItem shippingDiscounts(List<CommerceRuntimeAppliedLineItemShippingDiscount> shippingDiscounts) {
    
    this.shippingDiscounts = shippingDiscounts;
    return this;
  }

  public CommerceItem addShippingDiscountsItem(CommerceRuntimeAppliedLineItemShippingDiscount shippingDiscountsItem) {
  ...
  **/
  ...
  public CommerceItem data(Object data) {
  ...
  **/
  ...
  public CommerceItem taxData(Object taxData) {
  ...
  **/
  ...
  public CommerceItem auditInfo(AdminUserAuditInfo auditInfo) {
  ...
  **/
  ...
  public CommerceItem shippingAmountBeforeDiscountsAndAdjustments(Double shippingAmountBeforeDiscountsAndAdjustments) {
  ...
  **/
  ...
  public CommerceItem weightedOrderAdjustment(Double weightedOrderAdjustment) {
  ...
  **/
  ...
  public CommerceItem weightedOrderDiscount(Double weightedOrderDiscount) {
  ...
  **/
  ...
  public CommerceItem adjustedLineItemSubtotal(Double adjustedLineItemSubtotal) {
  ...
  **/
  ...
  public CommerceItem totalWithoutWeightedShippingAndHandling(Double totalWithoutWeightedShippingAndHandling) {
  ...
  **/
  ...
  public CommerceItem weightedOrderTax(Double weightedOrderTax) {
  ...
  **/
  ...
  public CommerceItem weightedOrderShipping(Double weightedOrderShipping) {
  ...
  **/
  ...
  public CommerceItem weightedOrderShippingDiscount(Double weightedOrderShippingDiscount) {
  ...
  **/
  ...
  public CommerceItem weightedOrderShippingManualAdjustment(Double weightedOrderShippingManualAdjustment) {
  ...
  **/
  ...
  public CommerceItem weightedOrderShippingTax(Double weightedOrderShippingTax) {
  ...
  **/
  ...
  public CommerceItem weightedOrderHandlingFee(Double weightedOrderHandlingFee) {
  ...
  **/
  ...
  public CommerceItem weightedOrderHandlingFeeTax(Double weightedOrderHandlingFeeTax) {
  ...
  **/
  ...
  public CommerceItem weightedOrderHandlingFeeDiscount(Double weightedOrderHandlingFeeDiscount) {
  ...
  **/
  ...
  public CommerceItem weightedOrderDuty(Double weightedOrderDuty) {
  ...
  **/
  ...
  public CommerceItem totalWithWeightedShippingAndHandling(Double totalWithWeightedShippingAndHandling) {
  ...
  **/
  ...
  public CommerceItem weightedOrderHandlingAdjustment(Double weightedOrderHandlingAdjustment) {
  ...
  **/
  ...
  public CommerceItem autoAddDiscountId(Integer autoAddDiscountId) {
  ...
  **/
  ...
  public CommerceItem isAssemblyRequired(Boolean isAssemblyRequired) {
  ...
  **/
  ...
  public CommerceItem childItemIds(List<String> childItemIds) {
    
    this.childItemIds = childItemIds;
    return this;
  }

  public CommerceItem addChildItemIdsItem(String childItemIdsItem) {
  ...
  **/
  ...
  public CommerceItem parentItemId(String parentItemId) {
  ...
  **/
  ...
  public CommerceItem inventoryTags(List<InventoryTags> inventoryTags) {
    
    this.inventoryTags = inventoryTags;
    return this;
  }

  public CommerceItem addInventoryTagsItem(InventoryTags inventoryTagsItem) {
  ...
  **/
  ...
  public CommerceItem lineItemAdjustment(Double lineItemAdjustment) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.localeCode, commerceItem.localeCode) &&
        Objects.equals(this.purchaseLocation, commerceItem.purchaseLocation) &&
        Objects.equals(this.lineId, commerceItem.lineId) &&
        Objects.equals(this.product, commerceItem.product) &&
        Objects.equals(this.quantity, commerceItem.quantity) &&
        Objects.equals(this.isRecurring, commerceItem.isRecurring) &&
        Objects.equals(this.isTaxable, commerceItem.isTaxable) &&
        Objects.equals(this.subtotal, commerceItem.subtotal) &&
        Objects.equals(this.extendedTotal, commerceItem.extendedTotal) &&
        Objects.equals(this.taxableTotal, commerceItem.taxableTotal) &&
        Objects.equals(this.discountTotal, commerceItem.discountTotal) &&
        Objects.equals(this.discountedTotal, commerceItem.discountedTotal) &&
        Objects.equals(this.itemTaxTotal, commerceItem.itemTaxTotal) &&
        Objects.equals(this.shippingTaxTotal, commerceItem.shippingTaxTotal) &&
        Objects.equals(this.shippingTotal, commerceItem.shippingTotal) &&
        Objects.equals(this.handlingAmount, commerceItem.handlingAmount) &&
        Objects.equals(this.feeTotal, commerceItem.feeTotal) &&
        Objects.equals(this.total, commerceItem.total) &&
        Objects.equals(this.unitPrice, commerceItem.unitPrice) &&
        Objects.equals(this.productDiscount, commerceItem.productDiscount) &&
        Objects.equals(this.productDiscounts, commerceItem.productDiscounts) &&
        Objects.equals(this.shippingDiscounts, commerceItem.shippingDiscounts) &&
        Objects.equals(this.data, commerceItem.data) &&
        Objects.equals(this.taxData, commerceItem.taxData) &&
        Objects.equals(this.auditInfo, commerceItem.auditInfo) &&
        Objects.equals(this.shippingAmountBeforeDiscountsAndAdjustments, commerceItem.shippingAmountBeforeDiscountsAndAdjustments) &&
        Objects.equals(this.weightedOrderAdjustment, commerceItem.weightedOrderAdjustment) &&
        Objects.equals(this.weightedOrderDiscount, commerceItem.weightedOrderDiscount) &&
        Objects.equals(this.adjustedLineItemSubtotal, commerceItem.adjustedLineItemSubtotal) &&
        Objects.equals(this.totalWithoutWeightedShippingAndHandling, commerceItem.totalWithoutWeightedShippingAndHandling) &&
        Objects.equals(this.weightedOrderTax, commerceItem.weightedOrderTax) &&
        Objects.equals(this.weightedOrderShipping, commerceItem.weightedOrderShipping) &&
        Objects.equals(this.weightedOrderShippingDiscount, commerceItem.weightedOrderShippingDiscount) &&
        Objects.equals(this.weightedOrderShippingManualAdjustment, commerceItem.weightedOrderShippingManualAdjustment) &&
        Objects.equals(this.weightedOrderShippingTax, commerceItem.weightedOrderShippingTax) &&
        Objects.equals(this.weightedOrderHandlingFee, commerceItem.weightedOrderHandlingFee) &&
        Objects.equals(this.weightedOrderHandlingFeeTax, commerceItem.weightedOrderHandlingFeeTax) &&
        Objects.equals(this.weightedOrderHandlingFeeDiscount, commerceItem.weightedOrderHandlingFeeDiscount) &&
        Objects.equals(this.weightedOrderDuty, commerceItem.weightedOrderDuty) &&
        Objects.equals(this.totalWithWeightedShippingAndHandling, commerceItem.totalWithWeightedShippingAndHandling) &&
        Objects.equals(this.weightedOrderHandlingAdjustment, commerceItem.weightedOrderHandlingAdjustment) &&
        Objects.equals(this.autoAddDiscountId, commerceItem.autoAddDiscountId) &&
        Objects.equals(this.isAssemblyRequired, commerceItem.isAssemblyRequired) &&
        Objects.equals(this.childItemIds, commerceItem.childItemIds) &&
        Objects.equals(this.parentItemId, commerceItem.parentItemId) &&
        Objects.equals(this.inventoryTags, commerceItem.inventoryTags) &&
        Objects.equals(this.lineItemAdjustment, commerceItem.lineItemAdjustment);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommerceItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommerceItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommerceItem is not found in the empty JSON string", CommerceItem.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!CommerceItem.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommerceItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommerceItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommerceItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommerceItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommerceItem.class));

       return (TypeAdapter<T>) new TypeAdapter<CommerceItem>() {
           @Override
           public void write(JsonWriter out, CommerceItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommerceItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CommerceItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CommerceItem
  * @throws IOException if the JSON string is invalid with respect to CommerceItem
  */
  public static CommerceItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommerceItem.class);
  }

 /**
  * Convert an instance of CommerceItem to an JSON string
  *
  * @return JSON string
  */
