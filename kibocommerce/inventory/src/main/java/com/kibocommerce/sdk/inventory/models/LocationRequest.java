...
public class LocationRequest implements Serializable {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("directShip");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationRequest is not found in the empty JSON string", LocationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!LocationRequest.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LocationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationRequest>() {
           @Override
           public void write(JsonWriter out, LocationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LocationRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LocationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationRequest
  * @throws IOException if the JSON string is invalid with respect to LocationRequest
  */
  public static LocationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationRequest.class);
  }

 /**
  * Convert an instance of LocationRequest to an JSON string
  *
  * @return JSON string
  */
