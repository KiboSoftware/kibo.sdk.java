...
public class PricingRuntimeDiscountTarget implements Serializable {
  ...
  public PricingRuntimeDiscountTarget() {
  }

  public PricingRuntimeDiscountTarget type(String type) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget includedCategoryIds(List<Integer> includedCategoryIds) {
    
    this.includedCategoryIds = includedCategoryIds;
    return this;
  }

  public PricingRuntimeDiscountTarget addIncludedCategoryIdsItem(Integer includedCategoryIdsItem) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget excludedCategoryIds(List<Integer> excludedCategoryIds) {
    
    this.excludedCategoryIds = excludedCategoryIds;
    return this;
  }

  public PricingRuntimeDiscountTarget addExcludedCategoryIdsItem(Integer excludedCategoryIdsItem) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget includedCategoriesOperator(String includedCategoriesOperator) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget excludedCategoriesOperator(String excludedCategoriesOperator) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget includedProductCodes(List<String> includedProductCodes) {
    
    this.includedProductCodes = includedProductCodes;
    return this;
  }

  public PricingRuntimeDiscountTarget addIncludedProductCodesItem(String includedProductCodesItem) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget excludedProductCodes(List<String> excludedProductCodes) {
    
    this.excludedProductCodes = excludedProductCodes;
    return this;
  }

  public PricingRuntimeDiscountTarget addExcludedProductCodesItem(String excludedProductCodesItem) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget includeAllProducts(Boolean includeAllProducts) {
   ...
   /**
   * When IncludeAllProducts is true then IncludedCategories and IncludedProducts are not evaluated and should be   empty.  Only exclusions apply.
   * @return includeAllProducts
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When IncludeAllProducts is true then IncludedCategories and IncludedProducts are not evaluated and should be   empty.  Only exclusions apply.")
  ...
  public PricingRuntimeDiscountTarget shippingMethods(List<String> shippingMethods) {
    
    this.shippingMethods = shippingMethods;
    return this;
  }

  public PricingRuntimeDiscountTarget addShippingMethodsItem(String shippingMethodsItem) {
  ...
  **/
  ...
  public PricingRuntimeDiscountTarget shippingZones(List<String> shippingZones) {
    
    this.shippingZones = shippingZones;
    return this;
  }

  public PricingRuntimeDiscountTarget addShippingZonesItem(String shippingZonesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PricingRuntimeDiscountTarget pricingRuntimeDiscountTarget = (PricingRuntimeDiscountTarget) o;
    return Objects.equals(this.type, pricingRuntimeDiscountTarget.type) &&
        Objects.equals(this.includedCategoryIds, pricingRuntimeDiscountTarget.includedCategoryIds) &&
        Objects.equals(this.excludedCategoryIds, pricingRuntimeDiscountTarget.excludedCategoryIds) &&
        Objects.equals(this.includedCategoriesOperator, pricingRuntimeDiscountTarget.includedCategoriesOperator) &&
        Objects.equals(this.excludedCategoriesOperator, pricingRuntimeDiscountTarget.excludedCategoriesOperator) &&
        Objects.equals(this.includedProductCodes, pricingRuntimeDiscountTarget.includedProductCodes) &&
        Objects.equals(this.excludedProductCodes, pricingRuntimeDiscountTarget.excludedProductCodes) &&
        Objects.equals(this.includeAllProducts, pricingRuntimeDiscountTarget.includeAllProducts) &&
        Objects.equals(this.shippingMethods, pricingRuntimeDiscountTarget.shippingMethods) &&
        Objects.equals(this.shippingZones, pricingRuntimeDiscountTarget.shippingZones);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingRuntimeDiscountTarget {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PricingRuntimeDiscountTarget
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PricingRuntimeDiscountTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingRuntimeDiscountTarget is not found in the empty JSON string", PricingRuntimeDiscountTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!PricingRuntimeDiscountTarget.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingRuntimeDiscountTarget` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingRuntimeDiscountTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingRuntimeDiscountTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingRuntimeDiscountTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingRuntimeDiscountTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingRuntimeDiscountTarget>() {
           @Override
           public void write(JsonWriter out, PricingRuntimeDiscountTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PricingRuntimeDiscountTarget read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PricingRuntimeDiscountTarget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PricingRuntimeDiscountTarget
  * @throws IOException if the JSON string is invalid with respect to PricingRuntimeDiscountTarget
  */
  public static PricingRuntimeDiscountTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingRuntimeDiscountTarget.class);
  }

 /**
  * Convert an instance of PricingRuntimeDiscountTarget to an JSON string
  *
  * @return JSON string
  */
