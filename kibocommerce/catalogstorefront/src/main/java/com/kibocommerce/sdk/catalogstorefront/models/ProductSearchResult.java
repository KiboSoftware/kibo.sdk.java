 ...
 */
@ApiModel(description = "Products and facets returned from search criteria supplied in a ProductSearch query.")
...
public class ProductSearchResult implements Serializable {
  ...
  public ProductSearchResult facets(List<CatalogRuntimesFacet> facets) {
    
    this.facets = facets;
    return this;
  }

  public ProductSearchResult addFacetsItem(CatalogRuntimesFacet facetsItem) {
    if (this.facets == null) {
  ...
  **/
  ...
  public ProductSearchResult solrDebugInfo(SolrDebugInfo solrDebugInfo) {
  ...
  **/
  ...
  public ProductSearchResult searchRedirect(String searchRedirect) {
  ...
  **/
  ...
  public ProductSearchResult searchEngine(String searchEngine) {
  ...
  **/
  ...
  public ProductSearchResult nextCursorMark(String nextCursorMark) {
  ...
  **/
  ...
  public ProductSearchResult spellcheck(CatalogRuntimesSpellcheck spellcheck) {
  ...
  **/
  ...
  public ProductSearchResult startIndex(Integer startIndex) {
  ...
  **/
  ...
  public ProductSearchResult pageSize(Integer pageSize) {
  ...
  **/
  ...
  public ProductSearchResult pageCount(Integer pageCount) {
  ...
  **/
  ...
  public ProductSearchResult totalCount(Integer totalCount) {
  ...
  **/
  ...
  public ProductSearchResult items(List<CatalogRuntimesProduct> items) {
    
    this.items = items;
    return this;
  }

  public ProductSearchResult addItemsItem(CatalogRuntimesProduct itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductSearchResult productSearchResult = (ProductSearchResult) o;
    return Objects.equals(this.facets, productSearchResult.facets) &&
        Objects.equals(this.solrDebugInfo, productSearchResult.solrDebugInfo) &&
        Objects.equals(this.searchRedirect, productSearchResult.searchRedirect) &&
        Objects.equals(this.searchEngine, productSearchResult.searchEngine) &&
        Objects.equals(this.nextCursorMark, productSearchResult.nextCursorMark) &&
        Objects.equals(this.spellcheck, productSearchResult.spellcheck) &&
        Objects.equals(this.startIndex, productSearchResult.startIndex) &&
        Objects.equals(this.pageSize, productSearchResult.pageSize) &&
        Objects.equals(this.pageCount, productSearchResult.pageCount) &&
        Objects.equals(this.totalCount, productSearchResult.totalCount) &&
        Objects.equals(this.items, productSearchResult.items);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductSearchResult
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductSearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductSearchResult is not found in the empty JSON string", ProductSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!ProductSearchResult.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductSearchResult` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductSearchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductSearchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductSearchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductSearchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductSearchResult>() {
           @Override
           public void write(JsonWriter out, ProductSearchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductSearchResult read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProductSearchResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductSearchResult
  * @throws IOException if the JSON string is invalid with respect to ProductSearchResult
  */
  public static ProductSearchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductSearchResult.class);
  }

 /**
  * Convert an instance of ProductSearchResult to an JSON string
  *
  * @return JSON string
  */
