...
public class RejectShipment implements Serializable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RejectShipment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RejectShipment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RejectShipment is not found in the empty JSON string", RejectShipment.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!RejectShipment.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RejectShipment` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RejectShipment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RejectShipment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RejectShipment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RejectShipment.class));

       return (TypeAdapter<T>) new TypeAdapter<RejectShipment>() {
           @Override
           public void write(JsonWriter out, RejectShipment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RejectShipment read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RejectShipment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RejectShipment
  * @throws IOException if the JSON string is invalid with respect to RejectShipment
  */
  public static RejectShipment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RejectShipment.class);
  }

 /**
  * Convert an instance of RejectShipment to an JSON string
  *
  * @return JSON string
  */
