...
public class FulfillmentCanceledItem implements Serializable {
  ...
  public FulfillmentCanceledItem() {
  }

  public FulfillmentCanceledItem actualPrice(BigDecimal actualPrice) {
  ...
  **/
  ...
  public FulfillmentCanceledItem allocatedQuantity(Integer allocatedQuantity) {
  ...
  **/
  ...
  public FulfillmentCanceledItem allowsBackOrder(Boolean allowsBackOrder) {
  ...
  **/
  ...
  public FulfillmentCanceledItem allowsFutureAllocate(Boolean allowsFutureAllocate) {
  ...
  **/
  ...
  public FulfillmentCanceledItem appeasementReason(FulfillmentAppeasementReason appeasementReason) {
  ...
  **/
  ...
  public FulfillmentCanceledItem attributes(Map<String, Object> attributes) {
    
    this.attributes = attributes;
    return this;
  }

  public FulfillmentCanceledItem putAttributesItem(String key, Object attributesItem) {
  ...
  **/
  ...
  public FulfillmentCanceledItem auditInfo(AuditInfo0 auditInfo) {
  ...
  **/
  ...
  public FulfillmentCanceledItem backorderReleaseDate(OffsetDateTime backorderReleaseDate) {
  ...
  **/
  ...
  public FulfillmentCanceledItem blockAssignment(Boolean blockAssignment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem canceledReason(FulfillmentCanceledReason canceledReason) {
  ...
  **/
  ...
  public FulfillmentCanceledItem cartItemId(String cartItemId) {
  ...
  **/
  ...
  public FulfillmentCanceledItem childItemIds(List<String> childItemIds) {
    
    this.childItemIds = childItemIds;
    return this;
  }

  public FulfillmentCanceledItem addChildItemIdsItem(String childItemIdsItem) {
  ...
  **/
  ...
  public FulfillmentCanceledItem creditCurrencyCode(String creditCurrencyCode) {
  ...
  **/
  ...
  public FulfillmentCanceledItem creditValue(BigDecimal creditValue) {
  ...
  **/
  ...
  public FulfillmentCanceledItem data(Map<String, Object> data) {
    
    this.data = data;
    return this;
  }

  public FulfillmentCanceledItem putDataItem(String key, Object dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public FulfillmentCanceledItem duty(BigDecimal duty) {
  ...
  **/
  ...
  public FulfillmentCanceledItem expectedDeliveryDate(OffsetDateTime expectedDeliveryDate) {
  ...
  **/
  ...
  public FulfillmentCanceledItem fulfillmentFields(List<FulfillmentFulfillmentField> fulfillmentFields) {
    
    this.fulfillmentFields = fulfillmentFields;
    return this;
  }

  public FulfillmentCanceledItem addFulfillmentFieldsItem(FulfillmentFulfillmentField fulfillmentFieldsItem) {
  ...
  **/
  ...
  public FulfillmentCanceledItem giftCards(List<FulfillmentGiftCard> giftCards) {
    
    this.giftCards = giftCards;
    return this;
  }

  public FulfillmentCanceledItem addGiftCardsItem(FulfillmentGiftCard giftCardsItem) {
  ...
  **/
  ...
  public FulfillmentCanceledItem goodsType(GoodsTypeEnum goodsType) {
  ...
  **/
  ...
  public FulfillmentCanceledItem handling(BigDecimal handling) {
  ...
  **/
  ...
  public FulfillmentCanceledItem handlingDiscount(BigDecimal handlingDiscount) {
  ...
  **/
  ...
  public FulfillmentCanceledItem handlingTax(BigDecimal handlingTax) {
  ...
  **/
  ...
  public FulfillmentCanceledItem imageUrl(String imageUrl) {
  ...
  **/
  ...
  public FulfillmentCanceledItem inventoryTags(List<FulfillmentInventoryTag> inventoryTags) {
    
    this.inventoryTags = inventoryTags;
    return this;
  }

  public FulfillmentCanceledItem addInventoryTagsItem(FulfillmentInventoryTag inventoryTagsItem) {
  ...
  **/
  ...
  public FulfillmentCanceledItem isAssemblyRequired(Boolean isAssemblyRequired) {
  ...
  **/
  ...
  public FulfillmentCanceledItem isPackagedStandAlone(Boolean isPackagedStandAlone) {
  ...
  **/
  ...
  public FulfillmentCanceledItem isReservedInventory(Boolean isReservedInventory) {
  ...
  **/
  ...
  public FulfillmentCanceledItem isTaxable(Boolean isTaxable) {
  ...
  **/
  ...
  public FulfillmentCanceledItem itemDiscount(BigDecimal itemDiscount) {
  ...
  **/
  ...
  public FulfillmentCanceledItem itemTax(BigDecimal itemTax) {
  ...
  **/
  ...
  public FulfillmentCanceledItem lineId(Integer lineId) {
  ...
  **/
  ...
  public FulfillmentCanceledItem lineItemAdjustment(BigDecimal lineItemAdjustment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem lineItemCost(BigDecimal lineItemCost) {
  ...
  **/
  ...
  public FulfillmentCanceledItem locatorName(String locatorName) {
  ...
  **/
  ...
  public FulfillmentCanceledItem manageStock(Boolean manageStock) {
  ...
  **/
  ...
  public FulfillmentCanceledItem name(String name) {
  ...
  **/
  ...
  public FulfillmentCanceledItem optionAttributeFQN(String optionAttributeFQN) {
  ...
  **/
  ...
  public FulfillmentCanceledItem options(List<FulfillmentProductOption> options) {
    
    this.options = options;
    return this;
  }

  public FulfillmentCanceledItem addOptionsItem(FulfillmentProductOption optionsItem) {
  ...
  **/
  ...
  public FulfillmentCanceledItem originalOrderItemId(String originalOrderItemId) {
  ...
  **/
  ...
  public FulfillmentCanceledItem originalQuantity(Integer originalQuantity) {
  ...
  **/
  ...
  public FulfillmentCanceledItem overridePrice(BigDecimal overridePrice) {
  ...
  **/
  ...
  public FulfillmentCanceledItem parentItemId(String parentItemId) {
  ...
  **/
  ...
  public FulfillmentCanceledItem partNumber(String partNumber) {
  ...
  **/
  ...
  public FulfillmentCanceledItem productCode(String productCode) {
  ...
  **/
  ...
  public FulfillmentCanceledItem quantity(Integer quantity) {
  ...
  **/
  ...
  public FulfillmentCanceledItem readyForPickupQuantity(Integer readyForPickupQuantity) {
  ...
  **/
  ...
  public FulfillmentCanceledItem shipping(BigDecimal shipping) {
  ...
  **/
  ...
  public FulfillmentCanceledItem shippingDiscount(BigDecimal shippingDiscount) {
  ...
  **/
  ...
  public FulfillmentCanceledItem shippingTax(BigDecimal shippingTax) {
  ...
  **/
  ...
  public FulfillmentCanceledItem sku(String sku) {
  ...
  **/
  ...
  public FulfillmentCanceledItem taxData(Object taxData) {
  ...
  **/
  ...
  public FulfillmentCanceledItem taxableHandling(BigDecimal taxableHandling) {
  ...
  **/
  ...
  public FulfillmentCanceledItem taxableLineItemCost(BigDecimal taxableLineItemCost) {
  ...
  **/
  ...
  public FulfillmentCanceledItem taxableShipping(BigDecimal taxableShipping) {
  ...
  **/
  ...
  public FulfillmentCanceledItem transferQuantity(Integer transferQuantity) {
  ...
  **/
  ...
  public FulfillmentCanceledItem trueTransferQuantity(Integer trueTransferQuantity) {
  ...
  **/
  ...
  public FulfillmentCanceledItem unitPrice(BigDecimal unitPrice) {
  ...
  **/
  ...
  public FulfillmentCanceledItem upc(String upc) {
  ...
  **/
  ...
  public FulfillmentCanceledItem variationProductCode(String variationProductCode) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weight(BigDecimal weight) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightUnit(String weightUnit) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightedDutyAdjustment(BigDecimal weightedDutyAdjustment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightedHandlingAdjustment(BigDecimal weightedHandlingAdjustment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightedHandlingTaxAdjustment(BigDecimal weightedHandlingTaxAdjustment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightedLineItemTaxAdjustment(BigDecimal weightedLineItemTaxAdjustment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightedShipmentAdjustment(BigDecimal weightedShipmentAdjustment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightedShippingAdjustment(BigDecimal weightedShippingAdjustment) {
  ...
  **/
  ...
  public FulfillmentCanceledItem weightedShippingTaxAdjustment(BigDecimal weightedShippingTaxAdjustment) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentCanceledItem fulfillmentCanceledItem = (FulfillmentCanceledItem) o;
    return Objects.equals(this.actualPrice, fulfillmentCanceledItem.actualPrice) &&
        Objects.equals(this.allocatedQuantity, fulfillmentCanceledItem.allocatedQuantity) &&
        Objects.equals(this.allowsBackOrder, fulfillmentCanceledItem.allowsBackOrder) &&
        Objects.equals(this.allowsFutureAllocate, fulfillmentCanceledItem.allowsFutureAllocate) &&
        Objects.equals(this.appeasementReason, fulfillmentCanceledItem.appeasementReason) &&
        Objects.equals(this.attributes, fulfillmentCanceledItem.attributes) &&
        Objects.equals(this.auditInfo, fulfillmentCanceledItem.auditInfo) &&
        Objects.equals(this.backorderReleaseDate, fulfillmentCanceledItem.backorderReleaseDate) &&
        Objects.equals(this.blockAssignment, fulfillmentCanceledItem.blockAssignment) &&
        Objects.equals(this.canceledReason, fulfillmentCanceledItem.canceledReason) &&
        Objects.equals(this.cartItemId, fulfillmentCanceledItem.cartItemId) &&
        Objects.equals(this.childItemIds, fulfillmentCanceledItem.childItemIds) &&
        Objects.equals(this.creditCurrencyCode, fulfillmentCanceledItem.creditCurrencyCode) &&
        Objects.equals(this.creditValue, fulfillmentCanceledItem.creditValue) &&
        Objects.equals(this.data, fulfillmentCanceledItem.data) &&
        Objects.equals(this.duty, fulfillmentCanceledItem.duty) &&
        Objects.equals(this.expectedDeliveryDate, fulfillmentCanceledItem.expectedDeliveryDate) &&
        Objects.equals(this.fulfillmentFields, fulfillmentCanceledItem.fulfillmentFields) &&
        Objects.equals(this.giftCards, fulfillmentCanceledItem.giftCards) &&
        Objects.equals(this.goodsType, fulfillmentCanceledItem.goodsType) &&
        Objects.equals(this.handling, fulfillmentCanceledItem.handling) &&
        Objects.equals(this.handlingDiscount, fulfillmentCanceledItem.handlingDiscount) &&
        Objects.equals(this.handlingTax, fulfillmentCanceledItem.handlingTax) &&
        Objects.equals(this.imageUrl, fulfillmentCanceledItem.imageUrl) &&
        Objects.equals(this.inventoryTags, fulfillmentCanceledItem.inventoryTags) &&
        Objects.equals(this.isAssemblyRequired, fulfillmentCanceledItem.isAssemblyRequired) &&
        Objects.equals(this.isPackagedStandAlone, fulfillmentCanceledItem.isPackagedStandAlone) &&
        Objects.equals(this.isReservedInventory, fulfillmentCanceledItem.isReservedInventory) &&
        Objects.equals(this.isTaxable, fulfillmentCanceledItem.isTaxable) &&
        Objects.equals(this.itemDiscount, fulfillmentCanceledItem.itemDiscount) &&
        Objects.equals(this.itemTax, fulfillmentCanceledItem.itemTax) &&
        Objects.equals(this.lineId, fulfillmentCanceledItem.lineId) &&
        Objects.equals(this.lineItemAdjustment, fulfillmentCanceledItem.lineItemAdjustment) &&
        Objects.equals(this.lineItemCost, fulfillmentCanceledItem.lineItemCost) &&
        Objects.equals(this.locatorName, fulfillmentCanceledItem.locatorName) &&
        Objects.equals(this.manageStock, fulfillmentCanceledItem.manageStock) &&
        Objects.equals(this.name, fulfillmentCanceledItem.name) &&
        Objects.equals(this.optionAttributeFQN, fulfillmentCanceledItem.optionAttributeFQN) &&
        Objects.equals(this.options, fulfillmentCanceledItem.options) &&
        Objects.equals(this.originalOrderItemId, fulfillmentCanceledItem.originalOrderItemId) &&
        Objects.equals(this.originalQuantity, fulfillmentCanceledItem.originalQuantity) &&
        Objects.equals(this.overridePrice, fulfillmentCanceledItem.overridePrice) &&
        Objects.equals(this.parentItemId, fulfillmentCanceledItem.parentItemId) &&
        Objects.equals(this.partNumber, fulfillmentCanceledItem.partNumber) &&
        Objects.equals(this.productCode, fulfillmentCanceledItem.productCode) &&
        Objects.equals(this.quantity, fulfillmentCanceledItem.quantity) &&
        Objects.equals(this.readyForPickupQuantity, fulfillmentCanceledItem.readyForPickupQuantity) &&
        Objects.equals(this.shipping, fulfillmentCanceledItem.shipping) &&
        Objects.equals(this.shippingDiscount, fulfillmentCanceledItem.shippingDiscount) &&
        Objects.equals(this.shippingTax, fulfillmentCanceledItem.shippingTax) &&
        Objects.equals(this.sku, fulfillmentCanceledItem.sku) &&
        Objects.equals(this.taxData, fulfillmentCanceledItem.taxData) &&
        Objects.equals(this.taxableHandling, fulfillmentCanceledItem.taxableHandling) &&
        Objects.equals(this.taxableLineItemCost, fulfillmentCanceledItem.taxableLineItemCost) &&
        Objects.equals(this.taxableShipping, fulfillmentCanceledItem.taxableShipping) &&
        Objects.equals(this.transferQuantity, fulfillmentCanceledItem.transferQuantity) &&
        Objects.equals(this.trueTransferQuantity, fulfillmentCanceledItem.trueTransferQuantity) &&
        Objects.equals(this.unitPrice, fulfillmentCanceledItem.unitPrice) &&
        Objects.equals(this.upc, fulfillmentCanceledItem.upc) &&
        Objects.equals(this.variationProductCode, fulfillmentCanceledItem.variationProductCode) &&
        Objects.equals(this.weight, fulfillmentCanceledItem.weight) &&
        Objects.equals(this.weightUnit, fulfillmentCanceledItem.weightUnit) &&
        Objects.equals(this.weightedDutyAdjustment, fulfillmentCanceledItem.weightedDutyAdjustment) &&
        Objects.equals(this.weightedHandlingAdjustment, fulfillmentCanceledItem.weightedHandlingAdjustment) &&
        Objects.equals(this.weightedHandlingTaxAdjustment, fulfillmentCanceledItem.weightedHandlingTaxAdjustment) &&
        Objects.equals(this.weightedLineItemTaxAdjustment, fulfillmentCanceledItem.weightedLineItemTaxAdjustment) &&
        Objects.equals(this.weightedShipmentAdjustment, fulfillmentCanceledItem.weightedShipmentAdjustment) &&
        Objects.equals(this.weightedShippingAdjustment, fulfillmentCanceledItem.weightedShippingAdjustment) &&
        Objects.equals(this.weightedShippingTaxAdjustment, fulfillmentCanceledItem.weightedShippingTaxAdjustment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actualPrice, allocatedQuantity, allowsBackOrder, allowsFutureAllocate, appeasementReason, attributes, auditInfo, backorderReleaseDate, blockAssignment, canceledReason, cartItemId, childItemIds, creditCurrencyCode, creditValue, data, duty, expectedDeliveryDate, fulfillmentFields, giftCards, goodsType, handling, handlingDiscount, handlingTax, imageUrl, inventoryTags, isAssemblyRequired, isPackagedStandAlone, isReservedInventory, isTaxable, itemDiscount, itemTax, lineId, lineItemAdjustment, lineItemCost, locatorName, manageStock, name, optionAttributeFQN, options, originalOrderItemId, originalQuantity, overridePrice, parentItemId, partNumber, productCode, quantity, readyForPickupQuantity, shipping, shippingDiscount, shippingTax, sku, taxData, taxableHandling, taxableLineItemCost, taxableShipping, transferQuantity, trueTransferQuantity, unitPrice, upc, variationProductCode, weight, weightUnit, weightedDutyAdjustment, weightedHandlingAdjustment, weightedHandlingTaxAdjustment, weightedLineItemTaxAdjustment, weightedShipmentAdjustment, weightedShippingAdjustment, weightedShippingTaxAdjustment);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FulfillmentCanceledItem {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FulfillmentCanceledItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FulfillmentCanceledItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentCanceledItem is not found in the empty JSON string", FulfillmentCanceledItem.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!FulfillmentCanceledItem.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FulfillmentCanceledItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FulfillmentCanceledItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentCanceledItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentCanceledItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentCanceledItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentCanceledItem.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentCanceledItem>() {
           @Override
           public void write(JsonWriter out, FulfillmentCanceledItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FulfillmentCanceledItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FulfillmentCanceledItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FulfillmentCanceledItem
  * @throws IOException if the JSON string is invalid with respect to FulfillmentCanceledItem
  */
  public static FulfillmentCanceledItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentCanceledItem.class);
  }

 /**
  * Convert an instance of FulfillmentCanceledItem to an JSON string
  *
  * @return JSON string
  */
