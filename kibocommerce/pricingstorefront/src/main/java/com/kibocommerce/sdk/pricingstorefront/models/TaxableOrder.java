...
import com.kibocommerce.sdk.pricingstorefront.models.TaxContext;
 ...
 */
@ApiModel(description = "Properties of a taxable order")
...
public class TaxableOrder implements Serializable {
  ...
  public TaxableOrder orderDate(OffsetDateTime orderDate) {
  ...
  **/
  ...
  public TaxableOrder taxContext(TaxContext taxContext) {
  ...
  **/
  ...
  public TaxableOrder lineItems(List<TaxableLineItem> lineItems) {
    
    this.lineItems = lineItems;
    return this;
  }

  public TaxableOrder addLineItemsItem(TaxableLineItem lineItemsItem) {
  ...
  **/
  ...
  public TaxableOrder shippingAmount(Double shippingAmount) {
  ...
  **/
  ...
  public TaxableOrder currencyCode(String currencyCode) {
  ...
  **/
  ...
  public TaxableOrder handlingFee(Double handlingFee) {
  ...
  **/
  ...
  public TaxableOrder originalDocumentCode(String originalDocumentCode) {
  ...
  **/
  ...
  public TaxableOrder orderId(String orderId) {
  ...
  **/
  ...
  public TaxableOrder orderNumber(Integer orderNumber) {
  ...
  **/
  ...
  public TaxableOrder originalOrderDate(OffsetDateTime originalOrderDate) {
  ...
  **/
  ...
  public TaxableOrder data(Object data) {
  ...
  **/
  ...
  public TaxableOrder attributes(List<TaxAttribute> attributes) {
    
    this.attributes = attributes;
    return this;
  }

  public TaxableOrder addAttributesItem(TaxAttribute attributesItem) {
  ...
  **/
  ...
  public TaxableOrder shippingDiscounts(List<AppliedOrderShippingDiscount> shippingDiscounts) {
    
    this.shippingDiscounts = shippingDiscounts;
    return this;
  }

  public TaxableOrder addShippingDiscountsItem(AppliedOrderShippingDiscount shippingDiscountsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The list of historically-applied shipping discounts.  The active one will have IsExcluded == false")
  ...
  public TaxableOrder shippingDiscount(AppliedOrderShippingDiscount shippingDiscount) {
  ...
  **/
  ...
  public TaxableOrder orderDiscounts(List<PricingRuntimeAppliedDiscount> orderDiscounts) {
    
    this.orderDiscounts = orderDiscounts;
    return this;
  }

  public TaxableOrder addOrderDiscountsItem(PricingRuntimeAppliedDiscount orderDiscountsItem) {
  ...
  **/
  ...
  public TaxableOrder orderDiscount(PricingRuntimeAppliedDiscount orderDiscount) {
  ...
  **/
  ...
  public TaxableOrder handlingDiscounts(List<PricingRuntimeAppliedDiscount> handlingDiscounts) {
    
    this.handlingDiscounts = handlingDiscounts;
    return this;
  }

  public TaxableOrder addHandlingDiscountsItem(PricingRuntimeAppliedDiscount handlingDiscountsItem) {
  ...
  **/
  ...
  public TaxableOrder handlingDiscount(PricingRuntimeAppliedDiscount handlingDiscount) {
  ...
  **/
  ...
  public TaxableOrder shippingMethodCode(String shippingMethodCode) {
  ...
  **/
  ...
  public TaxableOrder shippingMethodName(String shippingMethodName) {
  ...
  **/
  ...
  public TaxableOrder taxRequestType(String taxRequestType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TaxableOrder taxableOrder = (TaxableOrder) o;
    return Objects.equals(this.orderDate, taxableOrder.orderDate) &&
        Objects.equals(this.taxContext, taxableOrder.taxContext) &&
        Objects.equals(this.lineItems, taxableOrder.lineItems) &&
        Objects.equals(this.shippingAmount, taxableOrder.shippingAmount) &&
        Objects.equals(this.currencyCode, taxableOrder.currencyCode) &&
        Objects.equals(this.handlingFee, taxableOrder.handlingFee) &&
        Objects.equals(this.originalDocumentCode, taxableOrder.originalDocumentCode) &&
        Objects.equals(this.orderId, taxableOrder.orderId) &&
        Objects.equals(this.orderNumber, taxableOrder.orderNumber) &&
        Objects.equals(this.originalOrderDate, taxableOrder.originalOrderDate) &&
        Objects.equals(this.data, taxableOrder.data) &&
        Objects.equals(this.attributes, taxableOrder.attributes) &&
        Objects.equals(this.shippingDiscounts, taxableOrder.shippingDiscounts) &&
        Objects.equals(this.shippingDiscount, taxableOrder.shippingDiscount) &&
        Objects.equals(this.orderDiscounts, taxableOrder.orderDiscounts) &&
        Objects.equals(this.orderDiscount, taxableOrder.orderDiscount) &&
        Objects.equals(this.handlingDiscounts, taxableOrder.handlingDiscounts) &&
        Objects.equals(this.handlingDiscount, taxableOrder.handlingDiscount) &&
        Objects.equals(this.shippingMethodCode, taxableOrder.shippingMethodCode) &&
        Objects.equals(this.shippingMethodName, taxableOrder.shippingMethodName) &&
        Objects.equals(this.taxRequestType, taxableOrder.taxRequestType);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxableOrder
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxableOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxableOrder is not found in the empty JSON string", TaxableOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!TaxableOrder.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaxableOrder` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      
      // validate the optional field `taxContext`
      if (jsonObj.get("taxContext") != null && !jsonObj.get("taxContext").isJsonNull()) {
        TaxContext.validateJsonObject(jsonObj.getAsJsonObject("taxContext"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxableOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxableOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxableOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxableOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxableOrder>() {
           @Override
           public void write(JsonWriter out, TaxableOrder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaxableOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TaxableOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxableOrder
  * @throws IOException if the JSON string is invalid with respect to TaxableOrder
  */
  public static TaxableOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxableOrder.class);
  }

 /**
  * Convert an instance of TaxableOrder to an JSON string
  *
  * @return JSON string
  */
