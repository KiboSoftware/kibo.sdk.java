...
import com.kibocommerce.sdk.pricingstorefront.models.ItemTaxContext;
...
public class OrderTaxContext implements Serializable {
  ...
  private List<ItemTaxContext> itemTaxContexts = null;
  ...
  public OrderTaxContext() {
  }

  public OrderTaxContext itemTaxContexts(List<ItemTaxContext> itemTaxContexts) {
    
    this.itemTaxContexts = itemTaxContexts;
    return this;
  }

  public OrderTaxContext addItemTaxContextsItem(ItemTaxContext itemTaxContextsItem) {
  ...
  **/
  ...
  public OrderTaxContext shippingTax(Double shippingTax) {
  ...
  **/
  ...
  public OrderTaxContext handlingFeeTax(Double handlingFeeTax) {
  ...
  **/
  ...
  public OrderTaxContext orderTax(Double orderTax) {
  ...
  **/
  ...
  public OrderTaxContext taxData(Object taxData) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrderTaxContext orderTaxContext = (OrderTaxContext) o;
    return Objects.equals(this.itemTaxContexts, orderTaxContext.itemTaxContexts) &&
        Objects.equals(this.shippingTax, orderTaxContext.shippingTax) &&
        Objects.equals(this.handlingFeeTax, orderTaxContext.handlingFeeTax) &&
        Objects.equals(this.orderTax, orderTaxContext.orderTax) &&
        Objects.equals(this.taxData, orderTaxContext.taxData);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemTaxContexts, shippingTax, handlingFeeTax, orderTax, taxData);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderTaxContext {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderTaxContext
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderTaxContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderTaxContext is not found in the empty JSON string", OrderTaxContext.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!OrderTaxContext.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderTaxContext` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if (jsonObj.get("itemTaxContexts") != null && !jsonObj.get("itemTaxContexts").isJsonNull()) {
        ...
        if (jsonArrayitemTaxContexts != null) {
          ...
          for (int i = 0; i < jsonArrayitemTaxContexts.size(); i++) {
            ItemTaxContext.validateJsonObject(jsonArrayitemTaxContexts.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderTaxContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderTaxContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderTaxContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderTaxContext.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderTaxContext>() {
           @Override
           public void write(JsonWriter out, OrderTaxContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderTaxContext read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OrderTaxContext given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderTaxContext
  * @throws IOException if the JSON string is invalid with respect to OrderTaxContext
  */
  public static OrderTaxContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderTaxContext.class);
  }

 /**
  * Convert an instance of OrderTaxContext to an JSON string
  *
  * @return JSON string
  */
