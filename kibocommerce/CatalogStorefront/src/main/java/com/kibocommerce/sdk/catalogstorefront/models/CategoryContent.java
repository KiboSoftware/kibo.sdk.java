 ...
 */
@ApiModel(description = "Name of the category and optionally, a description, page title, friendly URL, associated images, and any metadata.")
...
public class CategoryContent implements Serializable {
  ...
  public CategoryContent categoryImages(List<CategoryImage> categoryImages) {
    
    this.categoryImages = categoryImages;
    return this;
  }

  public CategoryContent addCategoryImagesItem(CategoryImage categoryImagesItem) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Images associated with the category.")
  ...
  public CategoryContent name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the category as it appears on the storefront.")
  ...
  public CategoryContent description(String description) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Description of the category as it appears on the storefront.")
  ...
  public CategoryContent pageTitle(String pageTitle) {
  ...
  **/
  ...
  public CategoryContent metaTagTitle(String metaTagTitle) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Metadata title. Metadata can be used to manage information internally.")
  ...
  public CategoryContent metaTagDescription(String metaTagDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Metadata description. Metadata can be used to manage information internally.")
  ...
  public CategoryContent metaTagKeywords(String metaTagKeywords) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Metadata keywords. Metadata can be used to manage information internally.")
  ...
  public CategoryContent slug(String slug) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Human-readable identifier given to the category to create friendly URLs.")
  ...
  public boolean equals(Object o) {
    ...
    CategoryContent categoryContent = (CategoryContent) o;
    return Objects.equals(this.categoryImages, categoryContent.categoryImages) &&
        Objects.equals(this.name, categoryContent.name) &&
        Objects.equals(this.description, categoryContent.description) &&
        Objects.equals(this.pageTitle, categoryContent.pageTitle) &&
        Objects.equals(this.metaTagTitle, categoryContent.metaTagTitle) &&
        Objects.equals(this.metaTagDescription, categoryContent.metaTagDescription) &&
        Objects.equals(this.metaTagKeywords, categoryContent.metaTagKeywords) &&
        Objects.equals(this.slug, categoryContent.slug);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(categoryImages, name, description, pageTitle, metaTagTitle, metaTagDescription, metaTagKeywords, slug);
  }
  ...
  public String toString() {
    ...
    sb.append("class CategoryContent {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CategoryContent
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CategoryContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CategoryContent is not found in the empty JSON string", CategoryContent.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!CategoryContent.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CategoryContent` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if (jsonObj.get("categoryImages") != null && !jsonObj.get("categoryImages").isJsonNull()) {
        ...
        if (jsonArraycategoryImages != null) {
          ...
          for (int i = 0; i < jsonArraycategoryImages.size(); i++) {
            CategoryImage.validateJsonObject(jsonArraycategoryImages.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CategoryContent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CategoryContent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CategoryContent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CategoryContent.class));

       return (TypeAdapter<T>) new TypeAdapter<CategoryContent>() {
           @Override
           public void write(JsonWriter out, CategoryContent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CategoryContent read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CategoryContent given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CategoryContent
  * @throws IOException if the JSON string is invalid with respect to CategoryContent
  */
  public static CategoryContent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CategoryContent.class);
  }

 /**
  * Convert an instance of CategoryContent to an JSON string
  *
  * @return JSON string
  */
