 ...
 */
@ApiModel(description = "Image or video associated with a product.")
...
public class ProductImage implements Serializable {
  ...
  public ProductImage imageLabel(String imageLabel) {
  ...
  **/
  ...
  public ProductImage cmsId(String cmsId) {
  ...
  **/
  ...
  public ProductImage videoUrl(String videoUrl) {
  ...
  **/
  ...
  public ProductImage mediaType(String mediaType) {
  ...
  **/
  ...
  public ProductImage sequence(Integer sequence) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "For products with multiple images, the sequence is the order in which this image appears. Whole number data. Required.")
  ...
  public ProductImage productImageGroupId(String productImageGroupId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.imageLabel, productImage.imageLabel) &&
        Objects.equals(this.altText, productImage.altText) &&
        Objects.equals(this.imageUrl, productImage.imageUrl) &&
        Objects.equals(this.cmsId, productImage.cmsId) &&
        Objects.equals(this.videoUrl, productImage.videoUrl) &&
        Objects.equals(this.mediaType, productImage.mediaType) &&
        Objects.equals(this.sequence, productImage.sequence) &&
        Objects.equals(this.productImageGroupId, productImage.productImageGroupId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(imageLabel, altText, imageUrl, cmsId, videoUrl, mediaType, sequence, productImageGroupId);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductImage` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
