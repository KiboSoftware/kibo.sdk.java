...
public class CustomDataListFilter implements Serializable {
  ...
  public CustomDataListFilter() {
  }

  public CustomDataListFilter booleanOperator(BooleanOperatorEnum booleanOperator) {
  ...
  **/
  ...
  public CustomDataListFilter created(OffsetDateTime created) {
  ...
  **/
  ...
  public CustomDataListFilter creatorUsername(String creatorUsername) {
  ...
  **/
  ...
  public CustomDataListFilter customAttributeName(String customAttributeName) {
  ...
  **/
  ...
  public CustomDataListFilter customDataListID(Integer customDataListID) {
  ...
  **/
  ...
  public CustomDataListFilter dataPointExtensibleAttributeFQN(String dataPointExtensibleAttributeFQN) {
  ...
  **/
  ...
  public CustomDataListFilter dataPointExtensibleAttributeName(String dataPointExtensibleAttributeName) {
  ...
  **/
  ...
  public CustomDataListFilter dataPointExtensibleAttributeType(String dataPointExtensibleAttributeType) {
  ...
  **/
  ...
  public CustomDataListFilter dataPointExtensibleFilter(Boolean dataPointExtensibleFilter) {
  ...
  **/
  ...
  public CustomDataListFilter dotDelimitedPropertyName(String dotDelimitedPropertyName) {
  ...
  **/
  ...
  public CustomDataListFilter environmentID(Integer environmentID) {
  ...
  **/
  ...
  public CustomDataListFilter extensibleAttributeFQN(String extensibleAttributeFQN) {
  ...
  **/
  ...
  public CustomDataListFilter extensibleAttributeName(String extensibleAttributeName) {
  ...
  **/
  ...
  public CustomDataListFilter extensibleAttributeType(String extensibleAttributeType) {
  ...
  **/
  ...
  public CustomDataListFilter extensibleFilter(Boolean extensibleFilter) {
  ...
  **/
  ...
  public CustomDataListFilter filterID(Integer filterID) {
  ...
  **/
  ...
  public CustomDataListFilter filterUnit(UnitOfobject filterUnit) {
  ...
  **/
  ...
  public CustomDataListFilter name(String name) {
  ...
  **/
  ...
  public CustomDataListFilter pathString(String pathString) {
  ...
  **/
  ...
  public CustomDataListFilter persisted(Boolean persisted) {
  ...
  **/
  ...
  public CustomDataListFilter siteID(Integer siteID) {
  ...
  **/
  ...
  public CustomDataListFilter tenantID(Integer tenantID) {
  ...
  **/
  ...
  public CustomDataListFilter updated(OffsetDateTime updated) {
  ...
  **/
  ...
  public CustomDataListFilter updaterUsername(String updaterUsername) {
  ...
  **/
  ...
  public CustomDataListFilter userContext(UserContextInformation userContext) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomDataListFilter customDataListFilter = (CustomDataListFilter) o;
    return Objects.equals(this.booleanOperator, customDataListFilter.booleanOperator) &&
        Objects.equals(this.created, customDataListFilter.created) &&
        Objects.equals(this.creatorUsername, customDataListFilter.creatorUsername) &&
        Objects.equals(this.customAttributeName, customDataListFilter.customAttributeName) &&
        Objects.equals(this.customDataListID, customDataListFilter.customDataListID) &&
        Objects.equals(this.dataPointExtensibleAttributeFQN, customDataListFilter.dataPointExtensibleAttributeFQN) &&
        Objects.equals(this.dataPointExtensibleAttributeName, customDataListFilter.dataPointExtensibleAttributeName) &&
        Objects.equals(this.dataPointExtensibleAttributeType, customDataListFilter.dataPointExtensibleAttributeType) &&
        Objects.equals(this.dataPointExtensibleFilter, customDataListFilter.dataPointExtensibleFilter) &&
        Objects.equals(this.dotDelimitedPropertyName, customDataListFilter.dotDelimitedPropertyName) &&
        Objects.equals(this.environmentID, customDataListFilter.environmentID) &&
        Objects.equals(this.extensibleAttributeFQN, customDataListFilter.extensibleAttributeFQN) &&
        Objects.equals(this.extensibleAttributeName, customDataListFilter.extensibleAttributeName) &&
        Objects.equals(this.extensibleAttributeType, customDataListFilter.extensibleAttributeType) &&
        Objects.equals(this.extensibleFilter, customDataListFilter.extensibleFilter) &&
        Objects.equals(this.filterID, customDataListFilter.filterID) &&
        Objects.equals(this.filterUnit, customDataListFilter.filterUnit) &&
        Objects.equals(this.name, customDataListFilter.name) &&
        Objects.equals(this.pathString, customDataListFilter.pathString) &&
        Objects.equals(this.persisted, customDataListFilter.persisted) &&
        Objects.equals(this.siteID, customDataListFilter.siteID) &&
        Objects.equals(this.tenantID, customDataListFilter.tenantID) &&
        Objects.equals(this.updated, customDataListFilter.updated) &&
        Objects.equals(this.updaterUsername, customDataListFilter.updaterUsername) &&
        Objects.equals(this.userContext, customDataListFilter.userContext);
  }

  @Override
  public int hashCode() {
    return Objects.hash(booleanOperator, created, creatorUsername, customAttributeName, customDataListID, dataPointExtensibleAttributeFQN, dataPointExtensibleAttributeName, dataPointExtensibleAttributeType, dataPointExtensibleFilter, dotDelimitedPropertyName, environmentID, extensibleAttributeFQN, extensibleAttributeName, extensibleAttributeType, extensibleFilter, filterID, filterUnit, name, pathString, persisted, siteID, tenantID, updated, updaterUsername, userContext);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomDataListFilter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomDataListFilter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomDataListFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomDataListFilter is not found in the empty JSON string", CustomDataListFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!CustomDataListFilter.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomDataListFilter` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomDataListFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomDataListFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomDataListFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomDataListFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomDataListFilter>() {
           @Override
           public void write(JsonWriter out, CustomDataListFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomDataListFilter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CustomDataListFilter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomDataListFilter
  * @throws IOException if the JSON string is invalid with respect to CustomDataListFilter
  */
  public static CustomDataListFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomDataListFilter.class);
  }

 /**
  * Convert an instance of CustomDataListFilter to an JSON string
  *
  * @return JSON string
  */
