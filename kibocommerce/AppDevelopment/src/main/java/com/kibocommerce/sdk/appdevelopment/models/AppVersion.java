...
public class AppVersion implements Serializable {
  ...
  **/
  ...
  public AppVersion revision(Integer revision) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.majorVersion, appVersion.majorVersion) &&
        Objects.equals(this.minorVersion, appVersion.minorVersion) &&
        Objects.equals(this.revision, appVersion.revision);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppVersion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppVersion` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
