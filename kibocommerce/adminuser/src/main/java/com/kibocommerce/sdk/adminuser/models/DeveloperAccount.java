...
public class DeveloperAccount implements Serializable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeveloperAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeveloperAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeveloperAccount` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
