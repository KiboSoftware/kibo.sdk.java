...
import com.kibocommerce.sdk.orderrouting.models.CustomDataValueOfobject;
...
public class CustomDataValueFilter implements Serializable {
  ...
  public static final String SERIALIZED_NAME_CUSTOM_DATA_VALUE = "customDataValue";
  @SerializedName(SERIALIZED_NAME_CUSTOM_DATA_VALUE)
  private CustomDataValueOfobject customDataValue;
  ...
  public CustomDataValueFilter() {
  }

  public CustomDataValueFilter booleanOperator(BooleanOperatorEnum booleanOperator) {
  ...
  **/
  ...
  public CustomDataValueFilter created(OffsetDateTime created) {
  ...
  **/
  ...
  public CustomDataValueFilter creatorUsername(String creatorUsername) {
  ...
  **/
  ...
  public CustomDataValueFilter customAttributeName(String customAttributeName) {
  ...
  **/
  ...
  public CustomDataValueFilter customDataValue(CustomDataValueOfobject customDataValue) {
  ...
  **/
  ...
  public CustomDataValueOfobject getCustomDataValue() {
    return customDataValue;
  }


  public void setCustomDataValue(CustomDataValueOfobject customDataValue) {
    this.customDataValue = customDataValue;
  }


  public CustomDataValueFilter dataPointExtensibleAttributeFQN(String dataPointExtensibleAttributeFQN) {
  ...
  **/
  ...
  public CustomDataValueFilter dataPointExtensibleAttributeName(String dataPointExtensibleAttributeName) {
  ...
  **/
  ...
  public CustomDataValueFilter dataPointExtensibleAttributeType(String dataPointExtensibleAttributeType) {
  ...
  **/
  ...
  public CustomDataValueFilter dataPointExtensibleFilter(Boolean dataPointExtensibleFilter) {
  ...
  **/
  ...
  public CustomDataValueFilter dotDelimitedPropertyName(String dotDelimitedPropertyName) {
  ...
  **/
  ...
  public CustomDataValueFilter environmentID(Integer environmentID) {
  ...
  **/
  ...
  public CustomDataValueFilter extensibleAttributeFQN(String extensibleAttributeFQN) {
  ...
  **/
  ...
  public CustomDataValueFilter extensibleAttributeName(String extensibleAttributeName) {
  ...
  **/
  ...
  public CustomDataValueFilter extensibleAttributeType(String extensibleAttributeType) {
  ...
  **/
  ...
  public CustomDataValueFilter extensibleFilter(Boolean extensibleFilter) {
  ...
  **/
  ...
  public CustomDataValueFilter filterID(Integer filterID) {
  ...
  **/
  ...
  public CustomDataValueFilter filterUnit(UnitOfobject filterUnit) {
  ...
  **/
  ...
  public CustomDataValueFilter name(String name) {
  ...
  **/
  ...
  public CustomDataValueFilter pathString(String pathString) {
  ...
  **/
  ...
  public CustomDataValueFilter persisted(Boolean persisted) {
  ...
  **/
  ...
  public CustomDataValueFilter siteID(Integer siteID) {
  ...
  **/
  ...
  public CustomDataValueFilter tenantID(Integer tenantID) {
  ...
  **/
  ...
  public CustomDataValueFilter updated(OffsetDateTime updated) {
  ...
  **/
  ...
  public CustomDataValueFilter updaterUsername(String updaterUsername) {
  ...
  **/
  ...
  public CustomDataValueFilter userContext(UserContextInformation userContext) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomDataValueFilter customDataValueFilter = (CustomDataValueFilter) o;
    return Objects.equals(this.booleanOperator, customDataValueFilter.booleanOperator) &&
        Objects.equals(this.created, customDataValueFilter.created) &&
        Objects.equals(this.creatorUsername, customDataValueFilter.creatorUsername) &&
        Objects.equals(this.customAttributeName, customDataValueFilter.customAttributeName) &&
        Objects.equals(this.customDataValue, customDataValueFilter.customDataValue) &&
        Objects.equals(this.dataPointExtensibleAttributeFQN, customDataValueFilter.dataPointExtensibleAttributeFQN) &&
        Objects.equals(this.dataPointExtensibleAttributeName, customDataValueFilter.dataPointExtensibleAttributeName) &&
        Objects.equals(this.dataPointExtensibleAttributeType, customDataValueFilter.dataPointExtensibleAttributeType) &&
        Objects.equals(this.dataPointExtensibleFilter, customDataValueFilter.dataPointExtensibleFilter) &&
        Objects.equals(this.dotDelimitedPropertyName, customDataValueFilter.dotDelimitedPropertyName) &&
        Objects.equals(this.environmentID, customDataValueFilter.environmentID) &&
        Objects.equals(this.extensibleAttributeFQN, customDataValueFilter.extensibleAttributeFQN) &&
        Objects.equals(this.extensibleAttributeName, customDataValueFilter.extensibleAttributeName) &&
        Objects.equals(this.extensibleAttributeType, customDataValueFilter.extensibleAttributeType) &&
        Objects.equals(this.extensibleFilter, customDataValueFilter.extensibleFilter) &&
        Objects.equals(this.filterID, customDataValueFilter.filterID) &&
        Objects.equals(this.filterUnit, customDataValueFilter.filterUnit) &&
        Objects.equals(this.name, customDataValueFilter.name) &&
        Objects.equals(this.pathString, customDataValueFilter.pathString) &&
        Objects.equals(this.persisted, customDataValueFilter.persisted) &&
        Objects.equals(this.siteID, customDataValueFilter.siteID) &&
        Objects.equals(this.tenantID, customDataValueFilter.tenantID) &&
        Objects.equals(this.updated, customDataValueFilter.updated) &&
        Objects.equals(this.updaterUsername, customDataValueFilter.updaterUsername) &&
        Objects.equals(this.userContext, customDataValueFilter.userContext);
  }

  @Override
  public int hashCode() {
    return Objects.hash(booleanOperator, created, creatorUsername, customAttributeName, customDataValue, dataPointExtensibleAttributeFQN, dataPointExtensibleAttributeName, dataPointExtensibleAttributeType, dataPointExtensibleFilter, dotDelimitedPropertyName, environmentID, extensibleAttributeFQN, extensibleAttributeName, extensibleAttributeType, extensibleFilter, filterID, filterUnit, name, pathString, persisted, siteID, tenantID, updated, updaterUsername, userContext);
  }
  ...
  public String toString() {
    ...
    sb.append("    customDataValue: ").append(toIndentedString(customDataValue)).append("\n");
  ...
  static {
    ...
    openapiFields.add("customDataValue");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomDataValueFilter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomDataValueFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomDataValueFilter is not found in the empty JSON string", CustomDataValueFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!CustomDataValueFilter.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomDataValueFilter` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      // validate the optional field `customDataValue`
      if (jsonObj.get("customDataValue") != null && !jsonObj.get("customDataValue").isJsonNull()) {
        CustomDataValueOfobject.validateJsonObject(jsonObj.getAsJsonObject("customDataValue"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomDataValueFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomDataValueFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomDataValueFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomDataValueFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomDataValueFilter>() {
           @Override
           public void write(JsonWriter out, CustomDataValueFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomDataValueFilter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CustomDataValueFilter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomDataValueFilter
  * @throws IOException if the JSON string is invalid with respect to CustomDataValueFilter
  */
  public static CustomDataValueFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomDataValueFilter.class);
  }

 /**
  * Convert an instance of CustomDataValueFilter to an JSON string
  *
  * @return JSON string
  */
