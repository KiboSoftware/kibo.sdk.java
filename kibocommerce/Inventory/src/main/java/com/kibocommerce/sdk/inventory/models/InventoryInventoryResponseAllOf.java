...
public class InventoryInventoryResponseAllOf implements Serializable {
  ...
  public InventoryInventoryResponseAllOf() {
  }

  public InventoryInventoryResponseAllOf locationName(String locationName) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf locationCode(String locationCode) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf tenantID(Integer tenantID) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf onHand(Integer onHand) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf available(Integer available) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf allocated(Integer allocated) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf pending(Integer pending) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf partNumber(String partNumber) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf upc(String upc) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf sku(String sku) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf blockAssignment(Boolean blockAssignment) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf ltd(BigDecimal ltd) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf floor(Integer floor) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf safetyStock(Integer safetyStock) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf distance(BigDecimal distance) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf directShip(Boolean directShip) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf transferEnabled(Boolean transferEnabled) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf pickup(Boolean pickup) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf countryCode(String countryCode) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf currencyID(Integer currencyID) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf retailPrice(BigDecimal retailPrice) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf inventoryLocatorName(String inventoryLocatorName) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf attributes(List<String> attributes) {
    
    this.attributes = attributes;
    return this;
  }

  public InventoryInventoryResponseAllOf addAttributesItem(String attributesItem) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf taggedInventory(List<InventoryTagQuantity> taggedInventory) {
    
    this.taggedInventory = taggedInventory;
    return this;
  }

  public InventoryInventoryResponseAllOf addTaggedInventoryItem(InventoryTagQuantity taggedInventoryItem) {
  ...
  **/
  ...
  public InventoryInventoryResponseAllOf futureInventory(List<InventoryFutureInventory> futureInventory) {
    
    this.futureInventory = futureInventory;
    return this;
  }

  public InventoryInventoryResponseAllOf addFutureInventoryItem(InventoryFutureInventory futureInventoryItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    InventoryInventoryResponseAllOf inventoryInventoryResponseAllOf = (InventoryInventoryResponseAllOf) o;
    return Objects.equals(this.locationName, inventoryInventoryResponseAllOf.locationName) &&
        Objects.equals(this.locationCode, inventoryInventoryResponseAllOf.locationCode) &&
        Objects.equals(this.tenantID, inventoryInventoryResponseAllOf.tenantID) &&
        Objects.equals(this.onHand, inventoryInventoryResponseAllOf.onHand) &&
        Objects.equals(this.available, inventoryInventoryResponseAllOf.available) &&
        Objects.equals(this.allocated, inventoryInventoryResponseAllOf.allocated) &&
        Objects.equals(this.pending, inventoryInventoryResponseAllOf.pending) &&
        Objects.equals(this.partNumber, inventoryInventoryResponseAllOf.partNumber) &&
        Objects.equals(this.upc, inventoryInventoryResponseAllOf.upc) &&
        Objects.equals(this.sku, inventoryInventoryResponseAllOf.sku) &&
        Objects.equals(this.blockAssignment, inventoryInventoryResponseAllOf.blockAssignment) &&
        Objects.equals(this.ltd, inventoryInventoryResponseAllOf.ltd) &&
        Objects.equals(this.floor, inventoryInventoryResponseAllOf.floor) &&
        Objects.equals(this.safetyStock, inventoryInventoryResponseAllOf.safetyStock) &&
        Objects.equals(this.distance, inventoryInventoryResponseAllOf.distance) &&
        Objects.equals(this.directShip, inventoryInventoryResponseAllOf.directShip) &&
        Objects.equals(this.transferEnabled, inventoryInventoryResponseAllOf.transferEnabled) &&
        Objects.equals(this.pickup, inventoryInventoryResponseAllOf.pickup) &&
        Objects.equals(this.countryCode, inventoryInventoryResponseAllOf.countryCode) &&
        Objects.equals(this.currencyID, inventoryInventoryResponseAllOf.currencyID) &&
        Objects.equals(this.retailPrice, inventoryInventoryResponseAllOf.retailPrice) &&
        Objects.equals(this.inventoryLocatorName, inventoryInventoryResponseAllOf.inventoryLocatorName) &&
        Objects.equals(this.attributes, inventoryInventoryResponseAllOf.attributes) &&
        Objects.equals(this.taggedInventory, inventoryInventoryResponseAllOf.taggedInventory) &&
        Objects.equals(this.futureInventory, inventoryInventoryResponseAllOf.futureInventory);
  }

  @Override
  public int hashCode() {
    return Objects.hash(locationName, locationCode, tenantID, onHand, available, allocated, pending, partNumber, upc, sku, blockAssignment, ltd, floor, safetyStock, distance, directShip, transferEnabled, pickup, countryCode, currencyID, retailPrice, inventoryLocatorName, attributes, taggedInventory, futureInventory);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InventoryInventoryResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InventoryInventoryResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InventoryInventoryResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InventoryInventoryResponseAllOf is not found in the empty JSON string", InventoryInventoryResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!InventoryInventoryResponseAllOf.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InventoryInventoryResponseAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InventoryInventoryResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InventoryInventoryResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InventoryInventoryResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InventoryInventoryResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<InventoryInventoryResponseAllOf>() {
           @Override
           public void write(JsonWriter out, InventoryInventoryResponseAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InventoryInventoryResponseAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of InventoryInventoryResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InventoryInventoryResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to InventoryInventoryResponseAllOf
  */
  public static InventoryInventoryResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InventoryInventoryResponseAllOf.class);
  }

 /**
  * Convert an instance of InventoryInventoryResponseAllOf to an JSON string
  *
  * @return JSON string
  */
