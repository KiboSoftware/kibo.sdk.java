 ...
 */
@ApiModel(description = "Request needed for creating Export Settings S3")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CreateExportSettingsS3Request implements Serializable {
  ...
  public CreateExportSettingsS3Request() {
  }
  ...
  **/
  ...
  public CreateExportSettingsS3Request locationCode(String locationCode) {
  ...
  **/
  ...
  public CreateExportSettingsS3Request userID(Integer userID) {
  ...
  **/
  ...
  public CreateExportSettingsS3Request pageSize(Integer pageSize) {
  ...
  **/
  ...
  public CreateExportSettingsS3Request pageNum(Integer pageNum) {
  ...
  **/
  ...
  public CreateExportSettingsS3Request sortBy(String sortBy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.exportSettingsName, createExportSettingsS3Request.exportSettingsName) &&
        ...
        Objects.equals(this.locationCode, createExportSettingsS3Request.locationCode) &&
        Objects.equals(this.userID, createExportSettingsS3Request.userID) &&
        Objects.equals(this.pageSize, createExportSettingsS3Request.pageSize) &&
        Objects.equals(this.pageNum, createExportSettingsS3Request.pageNum) &&
        Objects.equals(this.sortBy, createExportSettingsS3Request.sortBy);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateExportSettingsS3Request
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateExportSettingsS3Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateExportSettingsS3Request is not found in the empty JSON string", CreateExportSettingsS3Request.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!CreateExportSettingsS3Request.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateExportSettingsS3Request` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateExportSettingsS3Request.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateExportSettingsS3Request.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateExportSettingsS3Request' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateExportSettingsS3Request> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateExportSettingsS3Request.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateExportSettingsS3Request>() {
           @Override
           public void write(JsonWriter out, CreateExportSettingsS3Request value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateExportSettingsS3Request read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateExportSettingsS3Request given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateExportSettingsS3Request
  * @throws IOException if the JSON string is invalid with respect to CreateExportSettingsS3Request
  */
  public static CreateExportSettingsS3Request fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateExportSettingsS3Request.class);
  }

 /**
  * Convert an instance of CreateExportSettingsS3Request to an JSON string
  *
  * @return JSON string
  */
