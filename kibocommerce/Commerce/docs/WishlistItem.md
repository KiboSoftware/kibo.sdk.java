...
|------------ | ------------- | ------------- | -------------|
|**id** | **String** | Unique identifier of the wishlist line item. System-supplied and read-only. |  [optional] |
|**comments** | **String** | Comments for the wishlist item that are entered by the wishlist owner |  [optional] |
|**priorityType** | **String** | Wishlist item priority that is a hint to how much this item is needed or desired |  [optional] |
|**purchasableStatusType** | **String** | Is the item purchasable? |  [optional] |
