...
public class PricingTaxContext implements Serializable {
  ...
  public PricingTaxContext() {
  }

  public PricingTaxContext taxContextId(String taxContextId) {
  ...
  **/
  ...
  public PricingTaxContext customerId(String customerId) {
  ...
  **/
  ...
  public PricingTaxContext taxExemptId(String taxExemptId) {
  ...
  **/
  ...
  public PricingTaxContext originAddress(CommerceRuntimeAddress originAddress) {
  ...
  **/
  ...
  public PricingTaxContext destinationAddress(CommerceRuntimeAddress destinationAddress) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PricingTaxContext pricingTaxContext = (PricingTaxContext) o;
    return Objects.equals(this.taxContextId, pricingTaxContext.taxContextId) &&
        Objects.equals(this.customerId, pricingTaxContext.customerId) &&
        Objects.equals(this.taxExemptId, pricingTaxContext.taxExemptId) &&
        Objects.equals(this.originAddress, pricingTaxContext.originAddress) &&
        Objects.equals(this.destinationAddress, pricingTaxContext.destinationAddress);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taxContextId, customerId, taxExemptId, originAddress, destinationAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingTaxContext {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PricingTaxContext
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PricingTaxContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingTaxContext is not found in the empty JSON string", PricingTaxContext.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!PricingTaxContext.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingTaxContext` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingTaxContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingTaxContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingTaxContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingTaxContext.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingTaxContext>() {
           @Override
           public void write(JsonWriter out, PricingTaxContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PricingTaxContext read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PricingTaxContext given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PricingTaxContext
  * @throws IOException if the JSON string is invalid with respect to PricingTaxContext
  */
  public static PricingTaxContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingTaxContext.class);
  }

 /**
  * Convert an instance of PricingTaxContext to an JSON string
  *
  * @return JSON string
  */
