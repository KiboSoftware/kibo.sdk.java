...
public class CheckPayment implements Serializable {
  ...
  public CheckPayment checkNumber(String checkNumber) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkNumber, checkPayment.checkNumber);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CheckPayment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CheckPayment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckPayment` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
