...
import com.kibocommerce.sdk.commerce.models.PackageItem;
...
public class CollectionOfPackageItem implements Serializable {
  ...
  public CollectionOfPackageItem() {
  }

  public CollectionOfPackageItem id(String id) {
  ...
  **/
  ...
  public CollectionOfPackageItem code(String code) {
  ...
  **/
  ...
  public CollectionOfPackageItem status(String status) {
  ...
  **/
  ...
  public CollectionOfPackageItem items(List<PackageItem> items) {
    
    this.items = items;
    return this;
  }

  public CollectionOfPackageItem addItemsItem(PackageItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public CollectionOfPackageItem fulfillmentDate(OffsetDateTime fulfillmentDate) {
  ...
  **/
  ...
  public CollectionOfPackageItem fulfillmentLocationCode(String fulfillmentLocationCode) {
  ...
  **/
  ...
  public CollectionOfPackageItem auditInfo(AdminUserAuditInfo auditInfo) {
  ...
  **/
  ...
  public CollectionOfPackageItem availableActions(List<String> availableActions) {
    
    this.availableActions = availableActions;
    return this;
  }

  public CollectionOfPackageItem addAvailableActionsItem(String availableActionsItem) {
  ...
  **/
  ...
  public CollectionOfPackageItem changeMessages(List<CommerceRuntimeChangeMessage> changeMessages) {
    
    this.changeMessages = changeMessages;
    return this;
  }

  public CollectionOfPackageItem addChangeMessagesItem(CommerceRuntimeChangeMessage changeMessagesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CollectionOfPackageItem collectionOfPackageItem = (CollectionOfPackageItem) o;
    return Objects.equals(this.id, collectionOfPackageItem.id) &&
        Objects.equals(this.code, collectionOfPackageItem.code) &&
        Objects.equals(this.status, collectionOfPackageItem.status) &&
        Objects.equals(this.items, collectionOfPackageItem.items) &&
        Objects.equals(this.fulfillmentDate, collectionOfPackageItem.fulfillmentDate) &&
        Objects.equals(this.fulfillmentLocationCode, collectionOfPackageItem.fulfillmentLocationCode) &&
        Objects.equals(this.auditInfo, collectionOfPackageItem.auditInfo) &&
        Objects.equals(this.availableActions, collectionOfPackageItem.availableActions) &&
        Objects.equals(this.changeMessages, collectionOfPackageItem.changeMessages);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionOfPackageItem {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollectionOfPackageItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollectionOfPackageItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionOfPackageItem is not found in the empty JSON string", CollectionOfPackageItem.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!CollectionOfPackageItem.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CollectionOfPackageItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionOfPackageItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionOfPackageItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectionOfPackageItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectionOfPackageItem.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectionOfPackageItem>() {
           @Override
           public void write(JsonWriter out, CollectionOfPackageItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CollectionOfPackageItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CollectionOfPackageItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CollectionOfPackageItem
  * @throws IOException if the JSON string is invalid with respect to CollectionOfPackageItem
  */
  public static CollectionOfPackageItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectionOfPackageItem.class);
  }

 /**
  * Convert an instance of CollectionOfPackageItem to an JSON string
  *
  * @return JSON string
  */
