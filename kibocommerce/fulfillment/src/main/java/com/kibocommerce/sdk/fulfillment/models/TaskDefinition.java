...
public class TaskDefinition implements Serializable {
  ...
  **/
  ...
  public TaskDefinition inputs(List<FulfillmentTaskInput> inputs) {
    
    this.inputs = inputs;
    return this;
  }

  public TaskDefinition addInputsItem(FulfillmentTaskInput inputsItem) {
    if (this.inputs == null) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaskDefinition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaskDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      //  if (!TaskDefinition.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaskDefinition` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
