...
public class TransferShipment implements Serializable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransferShipment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransferShipment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransferShipment is not found in the empty JSON string", TransferShipment.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!TransferShipment.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransferShipment` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransferShipment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransferShipment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransferShipment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransferShipment.class));

       return (TypeAdapter<T>) new TypeAdapter<TransferShipment>() {
           @Override
           public void write(JsonWriter out, TransferShipment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransferShipment read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TransferShipment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransferShipment
  * @throws IOException if the JSON string is invalid with respect to TransferShipment
  */
  public static TransferShipment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransferShipment.class);
  }

 /**
  * Convert an instance of TransferShipment to an JSON string
  *
  * @return JSON string
  */
