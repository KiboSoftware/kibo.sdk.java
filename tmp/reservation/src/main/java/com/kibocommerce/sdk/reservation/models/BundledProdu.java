...
public class BundledProdu implements Serializable {
  ...
  public BundledProdu productCode(String productCode) {
  ...
  **/
  ...
  public BundledProdu name(String name) {
  ...
  **/
  ...
  public BundledProdu goodsType(String goodsType) {
  ...
  **/
  ...
  public BundledProdu quantity(Integer quantity) {
  ...
  **/
  ...
  public BundledProdu optionAttributeFQN(String optionAttributeFQN) {
  ...
  **/
  ...
  public BundledProdu optionValue(Object optionValue) {
  ...
  **/
  ...
  public BundledProdu measurements(ReservationWebAPIPackageMeasurements measurements) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BundledProdu bundledProdu = (BundledProdu) o;
    return Objects.equals(this.productCode, bundledProdu.productCode) &&
        Objects.equals(this.name, bundledProdu.name) &&
        Objects.equals(this.goodsType, bundledProdu.goodsType) &&
        Objects.equals(this.quantity, bundledProdu.quantity) &&
        Objects.equals(this.optionAttributeFQN, bundledProdu.optionAttributeFQN) &&
        Objects.equals(this.optionValue, bundledProdu.optionValue) &&
        Objects.equals(this.measurements, bundledProdu.measurements);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productCode, name, goodsType, quantity, optionAttributeFQN, optionValue, measurements);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BundledProdu
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BundledProdu.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BundledProdu is not found in the empty JSON string", BundledProdu.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!BundledProdu.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BundledProdu` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BundledProdu.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BundledProdu' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BundledProdu> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BundledProdu.class));

       return (TypeAdapter<T>) new TypeAdapter<BundledProdu>() {
           @Override
           public void write(JsonWriter out, BundledProdu value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BundledProdu read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BundledProdu given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BundledProdu
  * @throws IOException if the JSON string is invalid with respect to BundledProdu
  */
  public static BundledProdu fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BundledProdu.class);
  }

 /**
  * Convert an instance of BundledProdu to an JSON string
  *
  * @return JSON string
  */
