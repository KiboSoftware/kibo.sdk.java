...
import com.kibocommerce.sdk.orderrouting.models.LocationCriteriaSet;
...
public class LocationCriteriaSetFilter implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String SERIALIZED_NAME_ACCEPT_NULLS = "acceptNulls";
  @SerializedName(SERIALIZED_NAME_ACCEPT_NULLS)
  ...
  private List<LocationCriteriaSetDataDefinition> definitions = null;
  ...
  public static final String SERIALIZED_NAME_LOCATION_CRITERIA_SET = "locationCriteriaSet";
  @SerializedName(SERIALIZED_NAME_LOCATION_CRITERIA_SET)
  private LocationCriteriaSet locationCriteriaSet;
  ...
  public LocationCriteriaSetFilter() {
  }

  public LocationCriteriaSetFilter acceptNulls(Boolean acceptNulls) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter booleanOperator(BooleanOperatorEnum booleanOperator) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter created(OffsetDateTime created) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter creatorUsername(String creatorUsername) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter customAttributeName(String customAttributeName) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter dataPointExtensibleAttributeFQN(String dataPointExtensibleAttributeFQN) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter dataPointExtensibleAttributeName(String dataPointExtensibleAttributeName) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter dataPointExtensibleAttributeType(String dataPointExtensibleAttributeType) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter dataPointExtensibleFilter(Boolean dataPointExtensibleFilter) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter definitions(List<LocationCriteriaSetDataDefinition> definitions) {
    
    this.definitions = definitions;
    return this;
  }

  public LocationCriteriaSetFilter addDefinitionsItem(LocationCriteriaSetDataDefinition definitionsItem) {
  ...
  **/
  ...
  public List<LocationCriteriaSetDataDefinition> getDefinitions() {
    return definitions;
  }


  public void setDefinitions(List<LocationCriteriaSetDataDefinition> definitions) {
    this.definitions = definitions;
  }


  public LocationCriteriaSetFilter dotDelimitedPropertyName(String dotDelimitedPropertyName) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter environmentID(Integer environmentID) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter extensibleAttributeFQN(String extensibleAttributeFQN) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter extensibleAttributeName(String extensibleAttributeName) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter extensibleAttributeType(String extensibleAttributeType) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter extensibleFilter(Boolean extensibleFilter) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter filterID(Integer filterID) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter filterUnit(UnitOfobject filterUnit) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter locationCriteriaSet(LocationCriteriaSet locationCriteriaSet) {
    
    this.locationCriteriaSet = locationCriteriaSet;
    return this;
  }

   /**
   * Get locationCriteriaSet
   * @return locationCriteriaSet
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public LocationCriteriaSet getLocationCriteriaSet() {
    return locationCriteriaSet;
  }


  public void setLocationCriteriaSet(LocationCriteriaSet locationCriteriaSet) {
    this.locationCriteriaSet = locationCriteriaSet;
  }


  public LocationCriteriaSetFilter name(String name) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter pathString(String pathString) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter persisted(Boolean persisted) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter siteID(Integer siteID) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter tenantID(Integer tenantID) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter updated(OffsetDateTime updated) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter updaterUsername(String updaterUsername) {
  ...
  **/
  ...
  public LocationCriteriaSetFilter userContext(UserContextInformation userContext) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LocationCriteriaSetFilter locationCriteriaSetFilter = (LocationCriteriaSetFilter) o;
    return Objects.equals(this.acceptNulls, locationCriteriaSetFilter.acceptNulls) &&
        Objects.equals(this.booleanOperator, locationCriteriaSetFilter.booleanOperator) &&
        Objects.equals(this.created, locationCriteriaSetFilter.created) &&
        Objects.equals(this.creatorUsername, locationCriteriaSetFilter.creatorUsername) &&
        Objects.equals(this.customAttributeName, locationCriteriaSetFilter.customAttributeName) &&
        Objects.equals(this.dataPointExtensibleAttributeFQN, locationCriteriaSetFilter.dataPointExtensibleAttributeFQN) &&
        Objects.equals(this.dataPointExtensibleAttributeName, locationCriteriaSetFilter.dataPointExtensibleAttributeName) &&
        Objects.equals(this.dataPointExtensibleAttributeType, locationCriteriaSetFilter.dataPointExtensibleAttributeType) &&
        Objects.equals(this.dataPointExtensibleFilter, locationCriteriaSetFilter.dataPointExtensibleFilter) &&
        Objects.equals(this.definitions, locationCriteriaSetFilter.definitions) &&
        Objects.equals(this.dotDelimitedPropertyName, locationCriteriaSetFilter.dotDelimitedPropertyName) &&
        Objects.equals(this.environmentID, locationCriteriaSetFilter.environmentID) &&
        Objects.equals(this.extensibleAttributeFQN, locationCriteriaSetFilter.extensibleAttributeFQN) &&
        Objects.equals(this.extensibleAttributeName, locationCriteriaSetFilter.extensibleAttributeName) &&
        Objects.equals(this.extensibleAttributeType, locationCriteriaSetFilter.extensibleAttributeType) &&
        Objects.equals(this.extensibleFilter, locationCriteriaSetFilter.extensibleFilter) &&
        Objects.equals(this.filterID, locationCriteriaSetFilter.filterID) &&
        Objects.equals(this.filterUnit, locationCriteriaSetFilter.filterUnit) &&
        Objects.equals(this.locationCriteriaSet, locationCriteriaSetFilter.locationCriteriaSet) &&
        Objects.equals(this.name, locationCriteriaSetFilter.name) &&
        Objects.equals(this.pathString, locationCriteriaSetFilter.pathString) &&
        Objects.equals(this.persisted, locationCriteriaSetFilter.persisted) &&
        Objects.equals(this.siteID, locationCriteriaSetFilter.siteID) &&
        Objects.equals(this.tenantID, locationCriteriaSetFilter.tenantID) &&
        Objects.equals(this.updated, locationCriteriaSetFilter.updated) &&
        Objects.equals(this.updaterUsername, locationCriteriaSetFilter.updaterUsername) &&
        Objects.equals(this.userContext, locationCriteriaSetFilter.userContext);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acceptNulls, booleanOperator, created, creatorUsername, customAttributeName, dataPointExtensibleAttributeFQN, dataPointExtensibleAttributeName, dataPointExtensibleAttributeType, dataPointExtensibleFilter, definitions, dotDelimitedPropertyName, environmentID, extensibleAttributeFQN, extensibleAttributeName, extensibleAttributeType, extensibleFilter, filterID, filterUnit, locationCriteriaSet, name, pathString, persisted, siteID, tenantID, updated, updaterUsername, userContext);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LocationCriteriaSetFilter {\n");
    sb.append("    acceptNulls: ").append(toIndentedString(acceptNulls)).append("\n");
    ...
    sb.append("    locationCriteriaSet: ").append(toIndentedString(locationCriteriaSet)).append("\n");
  ...
  static {
    ...
    openapiFields.add("locationCriteriaSet");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationCriteriaSetFilter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationCriteriaSetFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationCriteriaSetFilter is not found in the empty JSON string", LocationCriteriaSetFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!LocationCriteriaSetFilter.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationCriteriaSetFilter` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if (jsonObj.get("definitions") != null && !jsonObj.get("definitions").isJsonNull()) {
        ...
        if (jsonArraydefinitions != null) {
          ...
          for (int i = 0; i < jsonArraydefinitions.size(); i++) {
            LocationCriteriaSetDataDefinition.validateJsonObject(jsonArraydefinitions.get(i).getAsJsonObject());
          };
        }
      }
      ...
      // validate the optional field `locationCriteriaSet`
      if (jsonObj.get("locationCriteriaSet") != null && !jsonObj.get("locationCriteriaSet").isJsonNull()) {
        LocationCriteriaSet.validateJsonObject(jsonObj.getAsJsonObject("locationCriteriaSet"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationCriteriaSetFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationCriteriaSetFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationCriteriaSetFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationCriteriaSetFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationCriteriaSetFilter>() {
           @Override
           public void write(JsonWriter out, LocationCriteriaSetFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LocationCriteriaSetFilter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LocationCriteriaSetFilter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationCriteriaSetFilter
  * @throws IOException if the JSON string is invalid with respect to LocationCriteriaSetFilter
  */
  public static LocationCriteriaSetFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationCriteriaSetFilter.class);
  }

 /**
  * Convert an instance of LocationCriteriaSetFilter to an JSON string
  *
  * @return JSON string
  */
