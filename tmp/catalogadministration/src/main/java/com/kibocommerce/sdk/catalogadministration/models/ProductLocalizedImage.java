 ...
 */
@ApiModel(description = "Contains the image label and alternate text for a product image or video in the language specified by LocalCode.")
...
public class ProductLocalizedImage implements Serializable {
  ...
  public ProductLocalizedImage() {
  }

  public ProductLocalizedImage id(Integer id) {
  ...
  **/
  ...
  public ProductLocalizedImage localeCode(String localeCode) {
  ...
  **/
  ...
  public ProductLocalizedImage imageLabel(String imageLabel) {
  ...
  **/
  ...
  public ProductLocalizedImage altText(String altText) {
  ...
  **/
  ...
  public ProductLocalizedImage imageUrl(String imageUrl) {
  ...
  **/
  ...
  public ProductLocalizedImage cmsId(String cmsId) {
  ...
  **/
  ...
  public ProductLocalizedImage videoUrl(String videoUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "URL of a video associated with the product.")
  ...
  public ProductLocalizedImage mediaType(String mediaType) {
  ...
  **/
  ...
  public ProductLocalizedImage sequence(Integer sequence) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "For products with multiple images, the order in which this image appears on the storefront.")
  ...
  public ProductLocalizedImage productImageGroupId(String productImageGroupId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Image group to which this image belongs.  Default is null.")
  ...
  public boolean equals(Object o) {
    ...
    ProductLocalizedImage productLocalizedImage = (ProductLocalizedImage) o;
    return Objects.equals(this.id, productLocalizedImage.id) &&
        Objects.equals(this.localeCode, productLocalizedImage.localeCode) &&
        Objects.equals(this.imageLabel, productLocalizedImage.imageLabel) &&
        Objects.equals(this.altText, productLocalizedImage.altText) &&
        Objects.equals(this.imageUrl, productLocalizedImage.imageUrl) &&
        Objects.equals(this.cmsId, productLocalizedImage.cmsId) &&
        Objects.equals(this.videoUrl, productLocalizedImage.videoUrl) &&
        Objects.equals(this.mediaType, productLocalizedImage.mediaType) &&
        Objects.equals(this.sequence, productLocalizedImage.sequence) &&
        Objects.equals(this.productImageGroupId, productLocalizedImage.productImageGroupId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, localeCode, imageLabel, altText, imageUrl, cmsId, videoUrl, mediaType, sequence, productImageGroupId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductLocalizedImage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductLocalizedImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductLocalizedImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductLocalizedImage is not found in the empty JSON string", ProductLocalizedImage.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!ProductLocalizedImage.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductLocalizedImage` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if ((jsonObj.get("productImageGroupId") != null && !jsonObj.get("productImageGroupId").isJsonNull()) && !jsonObj.get("productImageGroupId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductLocalizedImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductLocalizedImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductLocalizedImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductLocalizedImage.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductLocalizedImage>() {
           @Override
           public void write(JsonWriter out, ProductLocalizedImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductLocalizedImage read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProductLocalizedImage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductLocalizedImage
  * @throws IOException if the JSON string is invalid with respect to ProductLocalizedImage
  */
  public static ProductLocalizedImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductLocalizedImage.class);
  }

 /**
  * Convert an instance of ProductLocalizedImage to an JSON string
  *
  * @return JSON string
  */
