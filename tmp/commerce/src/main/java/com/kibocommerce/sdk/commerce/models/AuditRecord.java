 ...
 */
@ApiModel(description = "Group a set of changes made by a single user into a single audit history entry.")
...
public class AuditRecord implements Serializable {
  ...
  private List<AuditRecordChange> changes = null;
  ...
  **/
  ...
  public AuditRecord changes(List<AuditRecordChange> changes) {
    
    this.changes = changes;
    return this;
  }

  public AuditRecord addChangesItem(AuditRecordChange changesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of changes for this audit history entry.")
  ...
  public AuditRecord auditInfo(AdminUserAuditInfo auditInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, auditRecord.id) &&
        ...
        Objects.equals(this.auditInfo, auditRecord.auditInfo);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, changes, auditInfo);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AuditRecord
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AuditRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuditRecord` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if (jsonObj.get("changes") != null && !jsonObj.get("changes").isJsonNull()) {
        ...
        if (jsonArraychanges != null) {
          ...
          for (int i = 0; i < jsonArraychanges.size(); i++) {
            AuditRecordChange.validateJsonObject(jsonArraychanges.get(i).getAsJsonObject());
          };
        }
      }
