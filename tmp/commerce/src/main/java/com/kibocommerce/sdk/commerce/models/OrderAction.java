...
public class OrderAction implements Serializable {
  ...
  public OrderAction actionName(String actionName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionName, orderAction.actionName);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      //  if (!OrderAction.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderAction` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
