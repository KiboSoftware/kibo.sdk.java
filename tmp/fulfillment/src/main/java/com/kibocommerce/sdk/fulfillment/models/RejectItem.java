...
public class RejectItem implements Serializable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RejectItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RejectItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RejectItem is not found in the empty JSON string", RejectItem.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!RejectItem.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RejectItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RejectItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RejectItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RejectItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RejectItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RejectItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RejectItem>() {
           @Override
           public void write(JsonWriter out, RejectItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RejectItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RejectItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RejectItem
  * @throws IOException if the JSON string is invalid with respect to RejectItem
  */
  public static RejectItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RejectItem.class);
  }

 /**
  * Convert an instance of RejectItem to an JSON string
  *
  * @return JSON string
  */
