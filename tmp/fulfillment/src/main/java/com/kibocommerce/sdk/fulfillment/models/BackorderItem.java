...
public class BackorderItem implements Serializable {
  ...
  **/
  ...
  public BackorderItem blockAssignment(Boolean blockAssignment) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backorderReleaseDate, backorderItem.backorderReleaseDate) &&
        Objects.equals(this.blockAssignment, backorderItem.blockAssignment) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backorderReleaseDate, blockAssignment, lineId, quantity);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BackorderItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BackorderItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BackorderItem is not found in the empty JSON string", BackorderItem.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!BackorderItem.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BackorderItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BackorderItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BackorderItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BackorderItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BackorderItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BackorderItem.class));

       return (TypeAdapter<T>) new TypeAdapter<BackorderItem>() {
           @Override
           public void write(JsonWriter out, BackorderItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BackorderItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BackorderItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BackorderItem
  * @throws IOException if the JSON string is invalid with respect to BackorderItem
  */
  public static BackorderItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BackorderItem.class);
  }

 /**
  * Convert an instance of BackorderItem to an JSON string
  *
  * @return JSON string
  */
