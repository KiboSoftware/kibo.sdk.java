...
public class TaxContext implements Serializable {
  ...
  public TaxContext taxContextId(String taxContextId) {
  ...
  **/
  ...
  public TaxContext customerId(String customerId) {
  ...
  **/
  ...
  public TaxContext taxExemptId(String taxExemptId) {
  ...
  **/
  ...
  public TaxContext originAddress(CommerceRuntimeAddress originAddress) {
  ...
  **/
  ...
  public TaxContext destinationAddress(CommerceRuntimeAddress destinationAddress) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.taxContextId, taxContext.taxContextId) &&
        Objects.equals(this.customerId, taxContext.customerId) &&
        Objects.equals(this.taxExemptId, taxContext.taxExemptId) &&
        Objects.equals(this.originAddress, taxContext.originAddress) &&
        Objects.equals(this.destinationAddress, taxContext.destinationAddress);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxContext
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxContext is not found in the empty JSON string", TaxContext.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!TaxContext.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaxContext` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxContext.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxContext>() {
           @Override
           public void write(JsonWriter out, TaxContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaxContext read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TaxContext given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxContext
  * @throws IOException if the JSON string is invalid with respect to TaxContext
  */
  public static TaxContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxContext.class);
  }

 /**
  * Convert an instance of TaxContext to an JSON string
  *
  * @return JSON string
  */
