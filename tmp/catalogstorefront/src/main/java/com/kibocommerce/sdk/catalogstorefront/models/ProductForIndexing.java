...
public class ProductForIndexing implements Serializable {
  ...
  private List<CatalogRuntimesProduct> slices = null;
  ...
  public ProductForIndexing() {
  }

  public ProductForIndexing slices(List<CatalogRuntimesProduct> slices) {
    
    this.slices = slices;
    return this;
  }

  public ProductForIndexing addSlicesItem(CatalogRuntimesProduct slicesItem) {
    if (this.slices == null) {
  ...
  **/
  ...
  public List<CatalogRuntimesProduct> getSlices() {
    return slices;
  }


  public void setSlices(List<CatalogRuntimesProduct> slices) {
    this.slices = slices;
  }


  public ProductForIndexing productCode(String productCode) {
  ...
  **/
  ...
  public ProductForIndexing purchaseLocation(String purchaseLocation) {
  ...
  **/
  ...
  public ProductForIndexing productSequence(Integer productSequence) {
  ...
  **/
  ...
  public ProductForIndexing productUsage(String productUsage) {
  ...
  **/
  ...
  public ProductForIndexing fulfillmentTypesSupported(List<String> fulfillmentTypesSupported) {
    
    this.fulfillmentTypesSupported = fulfillmentTypesSupported;
    return this;
  }

  public ProductForIndexing addFulfillmentTypesSupportedItem(String fulfillmentTypesSupportedItem) {
  ...
  **/
  ...
  public ProductForIndexing goodsType(String goodsType) {
  ...
  **/
  ...
  public ProductForIndexing bundledProducts(List<CatalogRuntimesBundledProduct> bundledProducts) {
    
    this.bundledProducts = bundledProducts;
    return this;
  }

  public ProductForIndexing addBundledProductsItem(CatalogRuntimesBundledProduct bundledProductsItem) {
  ...
  **/
  ...
  public ProductForIndexing content(ProductContent content) {
  ...
  **/
  ...
  public ProductForIndexing purchasableState(ProductPurchasableState purchasableState) {
  ...
  **/
  ...
  public ProductForIndexing isActive(Boolean isActive) {
  ...
  **/
  ...
  public ProductForIndexing publishState(String publishState) {
  ...
  **/
  ...
  public ProductForIndexing price(CatalogRuntimesProductPrice price) {
  ...
  **/
  ...
  public ProductForIndexing priceRange(ProductPriceRange priceRange) {
  ...
  **/
  ...
  public ProductForIndexing volumePriceBands(List<ProductVolumePrice> volumePriceBands) {
    
    this.volumePriceBands = volumePriceBands;
    return this;
  }

  public ProductForIndexing addVolumePriceBandsItem(ProductVolumePrice volumePriceBandsItem) {
  ...
  **/
  ...
  public ProductForIndexing volumePriceRange(ProductPriceRange volumePriceRange) {
  ...
  **/
  ...
  public ProductForIndexing availableShippingDiscounts(List<CatalogRuntimesDiscount> availableShippingDiscounts) {
    
    this.availableShippingDiscounts = availableShippingDiscounts;
    return this;
  }

  public ProductForIndexing addAvailableShippingDiscountsItem(CatalogRuntimesDiscount availableShippingDiscountsItem) {
  ...
  **/
  ...
  public ProductForIndexing productType(String productType) {
  ...
  **/
  ...
  public ProductForIndexing productTypeId(Integer productTypeId) {
  ...
  **/
  ...
  public ProductForIndexing isTaxable(Boolean isTaxable) {
  ...
  **/
  ...
  public ProductForIndexing isRecurring(Boolean isRecurring) {
  ...
  **/
  ...
  public ProductForIndexing pricingBehavior(CatalogRuntimesProductPricingBehaviorInfo pricingBehavior) {
  ...
  **/
  ...
  public ProductForIndexing inventoryInfo(CatalogRuntimesProductInventoryInfo inventoryInfo) {
  ...
  **/
  ...
  public ProductForIndexing createDate(OffsetDateTime createDate) {
  ...
  **/
  ...
  public ProductForIndexing updateDate(OffsetDateTime updateDate) {
  ...
  **/
  ...
  public ProductForIndexing dateFirstAvailableInCatalog(OffsetDateTime dateFirstAvailableInCatalog) {
  ...
  **/
  ...
  public ProductForIndexing catalogStartDate(OffsetDateTime catalogStartDate) {
  ...
  **/
  ...
  public ProductForIndexing catalogEndDate(OffsetDateTime catalogEndDate) {
  ...
  **/
  ...
  public ProductForIndexing daysAvailableInCatalog(Integer daysAvailableInCatalog) {
  ...
  **/
  ...
  public ProductForIndexing upc(String upc) {
  ...
  **/
  ...
  public ProductForIndexing upCs(List<String> upCs) {
    
    this.upCs = upCs;
    return this;
  }

  public ProductForIndexing addUpCsItem(String upCsItem) {
    if (this.upCs == null) {
  ...
  **/
  ...
  public ProductForIndexing mfgPartNumber(String mfgPartNumber) {
  ...
  **/
  ...
  public ProductForIndexing mfgPartNumbers(List<String> mfgPartNumbers) {
    
    this.mfgPartNumbers = mfgPartNumbers;
    return this;
  }

  public ProductForIndexing addMfgPartNumbersItem(String mfgPartNumbersItem) {
  ...
  **/
  ...
  public ProductForIndexing variationProductCode(String variationProductCode) {
  ...
  **/
  ...
  public ProductForIndexing categories(List<CatalogRuntimesCategory> categories) {
    
    this.categories = categories;
    return this;
  }

  public ProductForIndexing addCategoriesItem(CatalogRuntimesCategory categoriesItem) {
  ...
  **/
  ...
  public ProductForIndexing measurements(CatalogRuntimesPackageMeasurements measurements) {
  ...
  **/
  ...
  public ProductForIndexing isPackagedStandAlone(Boolean isPackagedStandAlone) {
  ...
  **/
  ...
  public ProductForIndexing properties(List<CatalogRuntimesProductProperty> properties) {
    
    this.properties = properties;
    return this;
  }

  public ProductForIndexing addPropertiesItem(CatalogRuntimesProductProperty propertiesItem) {
  ...
  **/
  ...
  public ProductForIndexing options(List<CatalogRuntimesProductOption> options) {
    
    this.options = options;
    return this;
  }

  public ProductForIndexing addOptionsItem(CatalogRuntimesProductOption optionsItem) {
  ...
  **/
  ...
  public ProductForIndexing variations(List<VariationSummary> variations) {
    
    this.variations = variations;
    return this;
  }

  public ProductForIndexing addVariationsItem(VariationSummary variationsItem) {
  ...
  **/
  ...
  public ProductForIndexing validPriceLists(List<String> validPriceLists) {
    
    this.validPriceLists = validPriceLists;
    return this;
  }

  public ProductForIndexing addValidPriceListsItem(String validPriceListsItem) {
  ...
  **/
  ...
  public ProductForIndexing locationsInStock(List<String> locationsInStock) {
    
    this.locationsInStock = locationsInStock;
    return this;
  }

  public ProductForIndexing addLocationsInStockItem(String locationsInStockItem) {
  ...
  **/
  ...
  public ProductForIndexing slicingAttributeFQN(String slicingAttributeFQN) {
  ...
  **/
  ...
  public ProductForIndexing productImageGroups(List<CatalogRuntimesProductImageGroup> productImageGroups) {
    
    this.productImageGroups = productImageGroups;
    return this;
  }

  public ProductForIndexing addProductImageGroupsItem(CatalogRuntimesProductImageGroup productImageGroupsItem) {
  ...
  **/
  ...
  public ProductForIndexing sliceValue(String sliceValue) {
  ...
  **/
  ...
  public ProductForIndexing productCollections(List<CatalogRuntimesProductCollectionInfo> productCollections) {
    
    this.productCollections = productCollections;
    return this;
  }

  public ProductForIndexing addProductCollectionsItem(CatalogRuntimesProductCollectionInfo productCollectionsItem) {
  ...
  **/
  ...
  public ProductForIndexing productCollectionMembers(List<ProductCollectionMember> productCollectionMembers) {
    
    this.productCollectionMembers = productCollectionMembers;
    return this;
  }

  public ProductForIndexing addProductCollectionMembersItem(ProductCollectionMember productCollectionMembersItem) {
  ...
  **/
  ...
  public ProductForIndexing collectionMembersProductContent(List<ProductContent> collectionMembersProductContent) {
    
    this.collectionMembersProductContent = collectionMembersProductContent;
    return this;
  }

  public ProductForIndexing addCollectionMembersProductContentItem(ProductContent collectionMembersProductContentItem) {
  ...
  **/
  ...
  public ProductForIndexing score(Double score) {
  ...
  **/
  ...
  public ProductForIndexing personalizationScore(Double personalizationScore) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductForIndexing productForIndexing = (ProductForIndexing) o;
    return Objects.equals(this.slices, productForIndexing.slices) &&
        Objects.equals(this.productCode, productForIndexing.productCode) &&
        Objects.equals(this.purchaseLocation, productForIndexing.purchaseLocation) &&
        Objects.equals(this.productSequence, productForIndexing.productSequence) &&
        Objects.equals(this.productUsage, productForIndexing.productUsage) &&
        Objects.equals(this.fulfillmentTypesSupported, productForIndexing.fulfillmentTypesSupported) &&
        Objects.equals(this.goodsType, productForIndexing.goodsType) &&
        Objects.equals(this.bundledProducts, productForIndexing.bundledProducts) &&
        Objects.equals(this.content, productForIndexing.content) &&
        Objects.equals(this.purchasableState, productForIndexing.purchasableState) &&
        Objects.equals(this.isActive, productForIndexing.isActive) &&
        Objects.equals(this.publishState, productForIndexing.publishState) &&
        Objects.equals(this.price, productForIndexing.price) &&
        Objects.equals(this.priceRange, productForIndexing.priceRange) &&
        Objects.equals(this.volumePriceBands, productForIndexing.volumePriceBands) &&
        Objects.equals(this.volumePriceRange, productForIndexing.volumePriceRange) &&
        Objects.equals(this.availableShippingDiscounts, productForIndexing.availableShippingDiscounts) &&
        Objects.equals(this.productType, productForIndexing.productType) &&
        Objects.equals(this.productTypeId, productForIndexing.productTypeId) &&
        Objects.equals(this.isTaxable, productForIndexing.isTaxable) &&
        Objects.equals(this.isRecurring, productForIndexing.isRecurring) &&
        Objects.equals(this.pricingBehavior, productForIndexing.pricingBehavior) &&
        Objects.equals(this.inventoryInfo, productForIndexing.inventoryInfo) &&
        Objects.equals(this.createDate, productForIndexing.createDate) &&
        Objects.equals(this.updateDate, productForIndexing.updateDate) &&
        Objects.equals(this.dateFirstAvailableInCatalog, productForIndexing.dateFirstAvailableInCatalog) &&
        Objects.equals(this.catalogStartDate, productForIndexing.catalogStartDate) &&
        Objects.equals(this.catalogEndDate, productForIndexing.catalogEndDate) &&
        Objects.equals(this.daysAvailableInCatalog, productForIndexing.daysAvailableInCatalog) &&
        Objects.equals(this.upc, productForIndexing.upc) &&
        Objects.equals(this.upCs, productForIndexing.upCs) &&
        Objects.equals(this.mfgPartNumber, productForIndexing.mfgPartNumber) &&
        Objects.equals(this.mfgPartNumbers, productForIndexing.mfgPartNumbers) &&
        Objects.equals(this.variationProductCode, productForIndexing.variationProductCode) &&
        Objects.equals(this.categories, productForIndexing.categories) &&
        Objects.equals(this.measurements, productForIndexing.measurements) &&
        Objects.equals(this.isPackagedStandAlone, productForIndexing.isPackagedStandAlone) &&
        Objects.equals(this.properties, productForIndexing.properties) &&
        Objects.equals(this.options, productForIndexing.options) &&
        Objects.equals(this.variations, productForIndexing.variations) &&
        Objects.equals(this.validPriceLists, productForIndexing.validPriceLists) &&
        Objects.equals(this.locationsInStock, productForIndexing.locationsInStock) &&
        Objects.equals(this.slicingAttributeFQN, productForIndexing.slicingAttributeFQN) &&
        Objects.equals(this.productImageGroups, productForIndexing.productImageGroups) &&
        Objects.equals(this.sliceValue, productForIndexing.sliceValue) &&
        Objects.equals(this.productCollections, productForIndexing.productCollections) &&
        Objects.equals(this.productCollectionMembers, productForIndexing.productCollectionMembers) &&
        Objects.equals(this.collectionMembersProductContent, productForIndexing.collectionMembersProductContent) &&
        Objects.equals(this.score, productForIndexing.score) &&
        Objects.equals(this.personalizationScore, productForIndexing.personalizationScore);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductForIndexing {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductForIndexing
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductForIndexing.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductForIndexing is not found in the empty JSON string", ProductForIndexing.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!ProductForIndexing.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductForIndexing` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
      ...
      if (jsonObj.get("slices") != null && !jsonObj.get("slices").isJsonNull()) {
        ...
        if (jsonArrayslices != null) {
          ...
          for (int i = 0; i < jsonArrayslices.size(); i++) {
            CatalogRuntimesProduct.validateJsonObject(jsonArrayslices.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductForIndexing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductForIndexing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductForIndexing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductForIndexing.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductForIndexing>() {
           @Override
           public void write(JsonWriter out, ProductForIndexing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductForIndexing read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProductForIndexing given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductForIndexing
  * @throws IOException if the JSON string is invalid with respect to ProductForIndexing
  */
  public static ProductForIndexing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductForIndexing.class);
  }

 /**
  * Convert an instance of ProductForIndexing to an JSON string
  *
  * @return JSON string
  */
