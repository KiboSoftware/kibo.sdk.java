...
public class InventoryRequestAllOf implements Serializable {
  ...
  private List<ItemQuantity> items = null;
  ...
  public InventoryRequestAllOf() {
  }

  public InventoryRequestAllOf type(TypeEnum type) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Inventory Request Type Enum")
  ...
  public InventoryRequestAllOf items(List<ItemQuantity> items) {
    
    this.items = items;
    return this;
  }

  public InventoryRequestAllOf addItemsItem(ItemQuantity itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public InventoryRequestAllOf requestLocation(RequestLocation requestLocation) {
  ...
  **/
  ...
  public InventoryRequestAllOf limit(Integer limit) {
  ...
  **/
  ...
  public InventoryRequestAllOf locationWhitelist(List<String> locationWhitelist) {
    
    this.locationWhitelist = locationWhitelist;
    return this;
  }

  public InventoryRequestAllOf addLocationWhitelistItem(String locationWhitelistItem) {
  ...
  **/
  ...
  public InventoryRequestAllOf locationPriorityList(List<String> locationPriorityList) {
    
    this.locationPriorityList = locationPriorityList;
    return this;
  }

  public InventoryRequestAllOf addLocationPriorityListItem(String locationPriorityListItem) {
  ...
  **/
  ...
  public InventoryRequestAllOf locationBlacklist(List<String> locationBlacklist) {
    
    this.locationBlacklist = locationBlacklist;
    return this;
  }

  public InventoryRequestAllOf addLocationBlacklistItem(String locationBlacklistItem) {
  ...
  **/
  ...
  public InventoryRequestAllOf ignoreSafetyStock(Boolean ignoreSafetyStock) {
  ...
  **/
  ...
  public InventoryRequestAllOf includeNegativeInventory(Boolean includeNegativeInventory) {
  ...
  **/
  ...
  public InventoryRequestAllOf directShip(Boolean directShip) {
  ...
  **/
  ...
  public InventoryRequestAllOf transferEnabled(Boolean transferEnabled) {
  ...
  **/
  ...
  public InventoryRequestAllOf pickup(Boolean pickup) {
  ...
  **/
  ...
  public InventoryRequestAllOf includeInAggregateExport(Boolean includeInAggregateExport) {
  ...
  **/
  ...
  public InventoryRequestAllOf includeInLocationExport(Boolean includeInLocationExport) {
  ...
  **/
  ...
  public InventoryRequestAllOf excludeBlockedAssignment(Boolean excludeBlockedAssignment) {
  ...
  **/
  ...
  public InventoryRequestAllOf includeAttributes(Boolean includeAttributes) {
  ...
  **/
  ...
  public InventoryRequestAllOf includeFutureInventory(Boolean includeFutureInventory) {
  ...
  **/
  ...
  public InventoryRequestAllOf includeNegativeFutureInventory(Boolean includeNegativeFutureInventory) {
  ...
  **/
  ...
  public InventoryRequestAllOf deliveryDateBefore(OffsetDateTime deliveryDateBefore) {
  ...
  **/
  ...
  public InventoryRequestAllOf deliveryDateAfter(OffsetDateTime deliveryDateAfter) {
  ...
  **/
  ...
  public InventoryRequestAllOf sortByEnum(SortByEnumEnum sortByEnum) {
  ...
  **/
  ...
  public InventoryRequestAllOf sortDescending(Boolean sortDescending) {
  ...
  **/
  ...
  public InventoryRequestAllOf forceDefaultsForUnspecifiedTagCategories(Boolean forceDefaultsForUnspecifiedTagCategories) {
  ...
  **/
  ...
  public InventoryRequestAllOf tags(Map<String, String> tags) {
    
    this.tags = tags;
    return this;
  }

  public InventoryRequestAllOf putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    InventoryRequestAllOf inventoryRequestAllOf = (InventoryRequestAllOf) o;
    return Objects.equals(this.type, inventoryRequestAllOf.type) &&
        Objects.equals(this.items, inventoryRequestAllOf.items) &&
        Objects.equals(this.requestLocation, inventoryRequestAllOf.requestLocation) &&
        Objects.equals(this.limit, inventoryRequestAllOf.limit) &&
        Objects.equals(this.locationWhitelist, inventoryRequestAllOf.locationWhitelist) &&
        Objects.equals(this.locationPriorityList, inventoryRequestAllOf.locationPriorityList) &&
        Objects.equals(this.locationBlacklist, inventoryRequestAllOf.locationBlacklist) &&
        Objects.equals(this.ignoreSafetyStock, inventoryRequestAllOf.ignoreSafetyStock) &&
        Objects.equals(this.includeNegativeInventory, inventoryRequestAllOf.includeNegativeInventory) &&
        Objects.equals(this.directShip, inventoryRequestAllOf.directShip) &&
        Objects.equals(this.transferEnabled, inventoryRequestAllOf.transferEnabled) &&
        Objects.equals(this.pickup, inventoryRequestAllOf.pickup) &&
        Objects.equals(this.includeInAggregateExport, inventoryRequestAllOf.includeInAggregateExport) &&
        Objects.equals(this.includeInLocationExport, inventoryRequestAllOf.includeInLocationExport) &&
        Objects.equals(this.excludeBlockedAssignment, inventoryRequestAllOf.excludeBlockedAssignment) &&
        Objects.equals(this.includeAttributes, inventoryRequestAllOf.includeAttributes) &&
        Objects.equals(this.includeFutureInventory, inventoryRequestAllOf.includeFutureInventory) &&
        Objects.equals(this.includeNegativeFutureInventory, inventoryRequestAllOf.includeNegativeFutureInventory) &&
        Objects.equals(this.deliveryDateBefore, inventoryRequestAllOf.deliveryDateBefore) &&
        Objects.equals(this.deliveryDateAfter, inventoryRequestAllOf.deliveryDateAfter) &&
        Objects.equals(this.sortByEnum, inventoryRequestAllOf.sortByEnum) &&
        Objects.equals(this.sortDescending, inventoryRequestAllOf.sortDescending) &&
        Objects.equals(this.forceDefaultsForUnspecifiedTagCategories, inventoryRequestAllOf.forceDefaultsForUnspecifiedTagCategories) &&
        Objects.equals(this.tags, inventoryRequestAllOf.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, items, requestLocation, limit, locationWhitelist, locationPriorityList, locationBlacklist, ignoreSafetyStock, includeNegativeInventory, directShip, transferEnabled, pickup, includeInAggregateExport, includeInLocationExport, excludeBlockedAssignment, includeAttributes, includeFutureInventory, includeNegativeFutureInventory, deliveryDateBefore, deliveryDateAfter, sortByEnum, sortDescending, forceDefaultsForUnspecifiedTagCategories, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InventoryRequestAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InventoryRequestAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InventoryRequestAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InventoryRequestAllOf is not found in the empty JSON string", InventoryRequestAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      //  if (!InventoryRequestAllOf.openapiFields.contains(entry.getKey())) {
      //    throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InventoryRequestAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
      //    }
      //  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InventoryRequestAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InventoryRequestAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InventoryRequestAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InventoryRequestAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<InventoryRequestAllOf>() {
           @Override
           public void write(JsonWriter out, InventoryRequestAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InventoryRequestAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of InventoryRequestAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InventoryRequestAllOf
  * @throws IOException if the JSON string is invalid with respect to InventoryRequestAllOf
  */
  public static InventoryRequestAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InventoryRequestAllOf.class);
  }

 /**
  * Convert an instance of InventoryRequestAllOf to an JSON string
  *
  * @return JSON string
  */
